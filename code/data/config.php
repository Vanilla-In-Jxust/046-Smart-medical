...
$config['db']['master']['username'] = 'sql_002_zhandash';
$config['db']['master']['password'] = 'c5Apz7NXdsP2R7im';
$config['db']['master']['port'] = '3306';
$config['db']['master']['database'] = 'sql_002_zhandash';
...
$config['setting']['authkey'] = '9e70d0c3';
