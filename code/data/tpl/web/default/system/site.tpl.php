			...
			<div>
				...
				<div class="form-files">
					...
					<div class="form-file">
						...
						<div class="form-value" ng-bind="settings.footerleft ? settings.footerleft : 'Powered by 系统 v2.0.0 © 2014-2018 www.ppym.vip'"></div>
						<div class="form-edit">
...
<script>
	...
	angular.module('systemApp').filter('mobile', function() {
