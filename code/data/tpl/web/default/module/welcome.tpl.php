	...
	<div class="panel we7-panel ">
		...
		<div class="panel-body">
			<div class="account-list">
				<div class="account-item main" ng-click="account_info.switchurl ? account_switch(account_info.switchurl) : ''" ng-if="account_info">
					<img ng-src="{{ account_info.logo }}" class="account-img logo" alt="" >
					<div class="info">
						<div class="title">
							{{ account_info.name }}
						</div>
				...
				<div class="account-item" ng-repeat="link_account in link_accounts" ng-if="$index < 4" ng-click="link_account.switchurl ? account_switch(link_account.switchurl) : ''"> <!-- 最多4个-->
		...
		<div class="panel-body">
			<div class="permission-box-list" ng-if="!(user_permissions | we7IsEmpty)">
				<div class="permission-box-item" ng-repeat="permission in user_permissions" ng-if="$index < 3"> <!-- 3个 -->
					<div class="logo">
						<img ng-src="{{permission.user_info.avatar || './resource/images/nopic-user.png'}}" alt="">
					</div>
					<div class="info">
