...
<div id="js-account-manage-base" ng-controller="AccountManageBase" ng-cloak>
	...
	<table class="table we7-table table-hover table-form">
		...
		<?php  if(in_array($account->typeSign, array(ACCOUNT_TYPE_SIGN, WXAPP_TYPE_SIGN, WEBAPP_TYPE_SIGN, XZAPP_TYPE_SIGN, BAIDUAPP_TYPE_SIGN, TOUTIAOAPP_TYPE_SIGN))) { ?>
		<tr>
		...
		<tr>
			...
			<td class="text-right">
				<div class="link-group" ng-if="founder || owner">
					...
					<?php  } else if($account_param->typeSign == PHONEAPP_TYPE_SIGN) { ?>
					<a href="<?php  echo url('site/entry/goodsbuyer', array('direct' => 1, 'm' => 'store', 'type' => STORE_TYPE_WXAPP_RENEW))?>">续费</a>
					<?php  } else if($account_param->typeSign == XZAPP_TYPE_SIGN) { ?>
					<a href="<?php  echo url('site/entry/goodsbuyer', array('direct' => 1, 'm' => 'store', 'type' => STORE_TYPE_ACCOUNT_RENEW))?>">续费</a>
					<?php  } else if($account_param->typeSign == ALIAPP_TYPE_SIGN) { ?>
					<a href="<?php  echo url('site/entry/goodsbuyer', array('direct' => 1, 'm' => 'store', 'type' => STORE_TYPE_WXAPP_RENEW))?>">续费</a>
					<?php  } ?>
					<?php  } ?>
...
<script>
	angular.module('accountApp').value('config', {
		...
		links: {
			...
			siteroot: "<?php echo in_array($account->typeSign, array(ACCOUNT_TYPE_SIGN, XZAPP_TYPE_SIGN)) ? $_W['siteroot'] : str_replace('http://', 'https://', $_W['siteroot'])?>",
		},
	});
