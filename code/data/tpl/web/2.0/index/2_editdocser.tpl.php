					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<select name="url" class="form-control" id="selector">
								...
								<option text='jQuery' value="/hyb_yl/zhuanjiasubpages/pages/orderedtime/orderedtime?key_words=shipinwenzhen" data-title='视频问诊' <?php if($res['url'] =='/hyb_yl/zhuanjiasubpages/pages/orderedtime/orderedtime?key_words=shipinwenzhen') { ?> selected="selected" <?php  } ?>>视频问诊</option>
								<option text='jQuery' value="/hyb_yl/zhuanjiasubpages/pages/orderedtime/orderedtime?key_words=dianhuajizhen" data-title='电话急诊' <?php if($res['url'] =='/hyb_yl/zhuanjiasubpages/pages/orderedtime/orderedtime?key_words=dianhuajizhen') { ?> selected="selected" <?php  } ?>>电话急诊</option>
								<option text='jQuery' value="/hyb_yl/zhuanjiasubpages/pages/zhuanjiatiwen/zhuanjiatiwen?key_words=tuwenwenzhen" data-title='图文问诊' <?php if($res['url'] =='/hyb_yl/zhuanjiasubpages/pages/zhuanjiatiwen/zhuanjiatiwen?key_words=tuwenwenzhen') { ?> selected="selected" <?php  } ?>>图文问诊</option>
								...
								<option text='jQuery' value="/hyb_yl/czhuanjiasubpages/pages/longsever/index?key_words=kuaisudaozhen" data-title='快速问诊' <?php if($res['url'] =='/hyb_yl/czhuanjiasubpages/pages/longsever/index?key_words=kuaisudaozhen') { ?> selected="selected" <?php  } ?>>快速问诊</option>
