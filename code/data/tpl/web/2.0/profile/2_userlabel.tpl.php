	...
	<div class="modal" id="myModal" style="display: flex;">
	  <div class="modal-dialog1" role="document">
	          ...
	          <div class="tab_box">
                ...
                <label class="col-sm-2 control-label">已选择</label>
	              <div class="df" id="tabBox_xz">
                    <?php  if(!empty($u_label)) { ?>
                      <?php  if(is_array($u_label)) { foreach($u_label as $lab) { ?>
	                  <div class="df tab_cg">
	                    <div class="tab_text"><?php  echo $lab;?></div>
       ...
       <label  class="col-sm-2 control-label" for="exampleInputEmail2">自定义标签</label>
          ...
          <input type="hidden" name="u_id" value="<?php  echo $u_id;?>" id='u_id'/>
