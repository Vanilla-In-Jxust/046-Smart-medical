                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                                    ...
                                    <div class="row row-fix tpl-category-container">
                                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                            <select class="form-control tpl-category-parent we7-select" id="category_parentjg" name="goods[jigou_one]" >
                                                ...
                                                <option value="<?php  echo $items['id'];?>" <?php  if($item['jigou_one'] ==$items['id']) { ?> selected="" <?php  } ?>><?php  echo $items['name'];?></option>
                                                <?php  } } ?>
                                            </select>
                                        </div>
                                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                            ...
                            <div class="form-group" style="display: block;">
                                <label class="col-xs-2 col-sm-2 col-md-2 col-lg-2 control-label">原价</label>
                            ...
                            <div class="form-group" >
                                ...
                                </div><label class="col-xs-1 col-sm-1 col-md-1 col-lg-1 control-label" style="padding-left: 0;padding-right: 0;">虚拟销量</label>
                                <div class="col-md-2" style="padding-right: 0;">
                                    <div class="input-group">
                        ...
                        <div class="panel-body">
                            <div class="panel-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" name="goods[sname]" id="name" class="form-control" value="<?php  echo $item['sname'];?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-xs-12 col-sm-3 col-md-2 col-lg-2 control-label">批准文号</label>
                                    <div class="col-md-6">
                                        <input type="text" name="goods[doc_num]" id="doc_num" class="form-control" value="<?php  echo $item['doc_num'];?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-xs-12 col-sm-3 col-md-2 col-lg-2 control-label">品牌名称</label>
                                    <div class="col-md-6">
                                        <input type="text" name="goods[pp_title]" id="pp_title" class="form-control" value="<?php  echo $item['pp_title'];?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-xs-12 col-sm-3 col-md-2 col-lg-2 control-label">单位</label>
                                    <div class="col-md-6">
                                        <input type="text" name="goods[company]" class="form-control" value="<?php  echo $item['company'];?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9 col-xs-12">
                                        <label class="radio-inline"><input type="radio" value="0" name="goods[ifcfy]" <?php  if($item['ifcfy'] == '0') { ?> checked <?php  } ?>> 处方药</label> <label class="radio-inline"><input type="radio" value="1" name="goods[ifcfy]" <?php  if($item['ifcfy'] == '1') { ?> checked <?php  } ?>> 非处方药</label>
                                    </div>
                                </div>
...
<!--                                     <div class="form-group">
									...
									<div class="col-sm-9">
										<select name="goods[s_id]" class="form-control">
                              ...
                              <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <div class="row row-fix tpl-category-container">
                                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                                <select class="form-control tpl-category-parent we7-select" name="goods[g_id]">
                                                    <option value="0">请选择一级分类</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9 col-xs-12">
                                    <textarea  name="goods[sdescribe]" cols="80" rows="6"><?php  echo $item['sdescribe'];?></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-xs-12 col-sm-3 col-md-2 control-label">成分</label>
                                    <div class="col-sm-9 col-xs-12">
                                    <textarea  name="goods[component]" cols="80" rows="6"><?php  echo $item['component'];?></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <div id="tboption"  <?php  if(count($guige) > 0 && $item['gg_type'] == '1') { ?> style="padding-left:15px;display:block" <?php  } else { ?>  style="display:none" <?php  } ?>>
                               ...
                               <th><div class=""><div style="padding-bottom:10px;text-align:center;">原价</div></div>
                               </th>
                               <th>
                    ...
                    $("#category_parentjg").on("change",function(){
                     ...
                     //查询二级
                        $.post("/index.php?c=site&a=entry&do=team&op=ajax&type=jgall&m=hyb_yl&id="+id,{id:id},function (res) {
                            ...
                            html += '<th><div class=""><div style="padding-bottom:10px;text-align:center;">原价<\/div><\/div><\/th>';
