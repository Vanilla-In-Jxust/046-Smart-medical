  ...
  .col-sm-2{
   	width:auto   
			...
			<ul class="nav nav-tabs">
				<li class="active">
					<a href="<?php  echo $this->createWeburl('medicine',array('op'=>'pharmacistlist','status'=>'1'))?>">入驻中<span class="label label-warning pull-right" style="margin-left: 10px;">1</span>
					</a>
				</li>
				<li>
					<a href="<?php  echo $this->createWeburl('medicine',array('op'=>'pharmacistlist','status'=>'2'))?>">待入驻</a>
				</li>
				<li>
					<a href="<?php  echo $this->createWeburl('medicine',array('op'=>'pharmacistlist','status'=>'3'))?>">暂停中</a>
				</li>
				<li>
					<a href="<?php  echo $this->createWeburl('medicine',array('op'=>'pharmacistlist','status'=>'4'))?>">已到期</a>
				</li>
				<li>
					<a href="<?php  echo $this->createWeburl('medicine',array('op'=>'pharmacistlist','status'=>'5'))?>">入驻拒绝</a>
				</li>
			</ul>
			<div class="app-content">
				<div class="app-filter">
					<div class="filter-action">
						<a href="<?php  echo $this->createWeburl('medicine',array('op'=>'edit_yaoshi'))?>" class="btn btn-primary">添加药师</a>
					</div>
				</div>
				<div class="app-filter">
							...
							<?php  if(is_array($list)) { foreach($list as $item) { ?>
								<tr>
									...
									<td style="overflow:visible;">
                                        ...
                                        <a class="btn btn-warning btn-sm" data-toggle="ajaxModal" href="<?php  echo $this->createWeburl('medicine',array('op'=>'shlist','id'=>$item['id']))?>">审核记录</a>
                                        <a class="btn btn-danger btn-sm" data-toggle="ajaxRemove" href="<?php  echo $this->createWeburl('medicine',array('op'=>'del_yaoshi','id'=>$item['id']))?>" data-confirm="确定要删除该药师吗？">立即删除</a>
                                    </td>
								</tr>
								<?php  } } ?>
							</tbody>
