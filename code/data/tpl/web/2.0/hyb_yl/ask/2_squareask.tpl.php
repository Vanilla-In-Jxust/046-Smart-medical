					...
					<div class="form-group" style="max-width: 1180px;">
						...
						<div class="col-sm-10">
							<div class="btn-group">
								...
								<a href="<?php  echo $this->createWebUrl('ask',array('op'=>'squareask','ispay'=>'1','start'=>$start,'end'=>$end,'keywordtype'=>$keywordtype,'keyword'=>$keyword,'p_type'=>$p_type,'ac'=>'squareask','hid'=>$_SESSION['hid']))?>" class="btn <?php  if($ispay == '1') { ?> btn-primary <?php  } else { ?> btn-default <?php  } ?>">待接诊</a>
								<a href="<?php  echo $this->createWebUrl('ask',array('op'=>'squareask','ispay'=>'2','start'=>$start,'end'=>$end,'keywordtype'=>$keywordtype,'keyword'=>$keyword,'p_type'=>$p_type,'ac'=>'squareask','hid'=>$_SESSION['hid']))?>" class="btn <?php  if($ispay == '2') { ?> btn-primary <?php  } else { ?> btn-default <?php  } ?>">接诊中</a>
								<a href="<?php  echo $this->createWebUrl('ask',array('op'=>'squareask','ispay'=>'3','start'=>$start,'end'=>$end,'keywordtype'=>$keywordtype,'keyword'=>$keyword,'p_type'=>$p_type,'ac'=>'squareask','hid'=>$_SESSION['hid']))?>" class="btn <?php  if($ispay == '3') { ?> btn-primary <?php  } else { ?> btn-default <?php  } ?>">已完成/待评价</a>
					...
					<div class="">
	                    ...
	                    ">
								...
								<div class="list-inner" style='text-align:center'>
									...
									<?php  } ?>
									<?php  if($item['ispay'] =='2') { ?>
									<span class="label label-warning">接诊中</span>
									<?php  } ?>
									<?php  if($item['ispay'] =='3') { ?>
