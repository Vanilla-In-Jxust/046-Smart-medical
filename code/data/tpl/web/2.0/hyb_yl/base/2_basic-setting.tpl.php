    ...
    <div class="app-content">
        ...
        <div class="app-form" id="interfaceManagement">
            <form action="" method="post" novalidate="novalidate">
                ...
                <div class="tab-content">
                    <div class="form-group">
                        <label class="col-sm-2 control-label">体检幻灯片</label>
                        <div class="col-sm-9">
                            <?php  echo tpl_form_field_multi_image('tj_thumb', $res['tj_thumb'])?>
                            <span class="help-block">可设置也可不设置，去幻灯片里也可以设置</span>
                        </div>
                    </div>

                    <div class="form-group">
                        <label class="col-sm-2 control-label">商品首页轮播图</label>
                        <div class="col-sm-9">
                            <?php  echo tpl_form_field_multi_image('goodslunb', $res['goodslunb'])?>
                        </div>
                    </div>
