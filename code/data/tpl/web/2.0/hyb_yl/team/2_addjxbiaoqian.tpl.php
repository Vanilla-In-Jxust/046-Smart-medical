...
<ul class="nav nav-tabs">
	<li ><a href="index.php?c=site&a=entry&do=team&op=jxbiaoqian&ac=jxbiaoqian&m=hyb_yl">标签列表</a></li>
	<li <?php  if(empty($id)) { ?>class="active"<?php  } ?>><a href="#">添加标签</a></li>
</ul>
...
<!-- 				<div class="panel-heading">编辑标签</div>
				...
				<div class="form-group">
					<label class="col-sm-2 control-label">标签名称<span class="must-fill">*</span></label>
					<div class="col-sm-9">
