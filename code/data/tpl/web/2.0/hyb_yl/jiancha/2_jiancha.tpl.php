							...
							<tbody>
							  <?php  if(is_array($res)) { foreach($res as $item) { ?>
								<tr>
									...
									<a class="btn btn-default btn-sm" href="/index.php?c=site&a=entry&do=jiancha&op=order_list&ac=order_list&m=hyb_yl&hid=<?php  echo $item['hid'];?>&h_id=<?php  echo $_SESSION['hid'];?>" title="查看">机构订单</a>
									<a class="btn btn-default btn-sm" href="/index.php?c=site&a=entry&do=jiancha&op=zhuanjia&ac=zhuanjia&m=hyb_yl&hid=<?php  echo $item['hid'];?>&h_id=<?php  echo $_SESSION['hid'];?>" title="查看">机构专家</a>
									<a class="btn btn-default btn-sm" href="/index.php?c=site&a=entry&do=jiancha&op=shouyi&ac=shouyi&m=hyb_yl&hid=<?php  echo $item['hid'];?>&h_id=<?php  echo $_SESSION['hid'];?>" title="查看">机构收益</a>
									<?php  if($item['state'] == 0) { ?>
					...
					<div class="app-table-foot clearfix">
						<div class="pull-left">
							<div id="de1" class="pull-left">
								<a href="javascript:;" class="btn btn-default min-width js-batch js-delete pass">删除选中机构</a>
							</div>
						</div>
