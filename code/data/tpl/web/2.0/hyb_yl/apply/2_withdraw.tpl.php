	...
	<div class="app-content">
		<div class="app-filter">
			<div class="filter-action">
				<a href="http://www.webstrongtech.com/web/index.php?c=site&a=entry&m=hyb_yl&p=distribution&ac=dissysbase&do=distributorlist&todo=adddis" class="btn btn-primary">添加分销商</a>
			</div>
			...
			<div class="table-responsive order-list">
				<table class="table table-hover">
					<thead class="navbar-inner">
						<tr>
							<th  class="text-center" style="width:50px;">提现人信息</th>
							<th  class="text-center"  style="width:50px;">提现类型</th>
							<th  class="text-center" style="width:50px;">提现金额</th>
							<th  class="text-center" style="width:50px;">提现方式</th>
							<th  class="text-center" style="width:50px;">手续费</th>
							<th  class="text-center" style="width:50px;">到账金额</th>
							<th  class="text-center" style="width:50px;">申请时间</th>
							<th  class="text-center" style="width:50px;">操作时间</th>
	...
	<script>
		$('.order-list').delegate('.canceldis', 'click', function(e){
				...
				util.nailConfirm(this, function(state) {
					if(!state) return;
					$.post("http://www.webstrongtech.com/web/index.php?c=site&a=entry&m=hyb_yl&p=distribution&ac=dissysbase&do=canceldis&", { id : id }, function(data){
						if(!data.errno){
