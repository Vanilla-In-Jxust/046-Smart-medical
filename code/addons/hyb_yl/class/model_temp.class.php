...
class model_temp {
	...
	static function getTemp(){
		...
		if( empty( $cache ) ){
			...
			$cache = pdo_get('hyb_yl_temp',$where,array('id','name'));
	...
	static function initTemp(){
		...
		// 电镀厂
		$isset = pdo_get('hyb_yl_temp',array('name'=>'电镀厂系统模板','issystem'=>1,'uniacid'=>0));
		if( empty( $isset ) ) {
			...
			$tdata = array(
				...
				'name' => '电镀厂系统模板',
				'number' => 1,
				'img' => '/addons/hyb_yl/public/images/dd_thumb.png',
				'issystem' => 1,
			);

			$res = pdo_insert('hyb_yl_temp',$tdata);
			$tid = pdo_insertid();
			self::insertddPage( $tid );
		}

		// 互联网
		$isset = pdo_get('hyb_yl_temp',array('name'=>'网络公司系统模板','issystem'=>1,'uniacid'=>0));
		if( empty( $isset ) ) {
			...
			$tdata = array(
				...
				'name' => '网络公司系统模板',
				'number' => 1,
				'img' => '/addons/hyb_yl/public/images/wl_thumb.png',
				'issystem' => 1,
			);
	...
	static function insertddPage( $tid ){
		...
		if( $tid > 0 ){
			...
			$dd1 = $_W['siteroot'].'/addons/hyb_yl/public/images/dd_1.jpg';
			$dd2 = $_W['siteroot'].'/addons/hyb_yl/public/images/dd_2.jpg';
			$dd3 = $_W['siteroot'].'/addons/hyb_yl/public/images/dd_3.jpg';
			$dd4 = $_W['siteroot'].'/addons/hyb_yl/public/images/dd_4.jpg';
			$dd5 = $_W['siteroot'].'/addons/hyb_yl/public/images/dd_5.jpg';
			$dd6 = $_W['siteroot'].'/addons/hyb_yl/public/images/dd_6.jpg';
			$dd7 = $_W['siteroot'].'/addons/hyb_yl/public/images/dd_7.jpg';

			$ddn1 = $_W['siteroot'].'/addons/hyb_yl/public/images/dd_n1.png';
			$ddn2 = $_W['siteroot'].'/addons/hyb_yl/public/images/dd_n2.png';
			$ddn3 = $_W['siteroot'].'/addons/hyb_yl/public/images/dd_n3.png';
			$ddn4 = $_W['siteroot'].'/addons/hyb_yl/public/images/dd_n4.png';

			$foot1 = $_W['siteroot'].'/addons/hyb_yl/public/images/home1.png';
			$foot2 = $_W['siteroot'].'/addons/hyb_yl/public/images/home2.png';
			$foot3 = $_W['siteroot'].'/addons/hyb_yl/public/images/tel1.png';
			$foot4 = $_W['siteroot'].'/addons/hyb_yl/public/images/tel2.png';
			$foot5 = $_W['siteroot'].'/addons/hyb_yl/public/images/location1.png';
			$foot6 = $_W['siteroot'].'/addons/hyb_yl/public/images/location2.png';
			$foot7 = $_W['siteroot'].'/addons/hyb_yl/public/images/share1.png';
			$foot8 = $_W['siteroot'].'/addons/hyb_yl/public/images/share2.png';
			...
			$bdata = array(
				...
				'tempid' => $tid,
				'createtime' => TIMESTAMP,
				'data' => 'a:6:{s:3:"num";s:1:"4";s:7:"padding";s:1:"5";s:7:"bgcolor";s:7:"#ffffff";s:5:"color";s:4:"#999";s:8:"actcolor";s:7:"#ed414a";s:4:"data";a:4:{i:0;a:9:{s:2:"id";s:8:"00000001";s:4:"name";s:6:"首页";s:3:"img";s:80:"'.$foot1.'";s:6:"actimg";s:80:"'.$foot2.'";s:3:"url";s:38:"/hyb_yl/pages/page/page?pid='.$indexid.'";s:4:"type";s:3:"url";s:9:"$$hashKey";s:9:"object:20";s:6:"pageid";s:2:"'.$indexid.'";s:7:"urlname";s:6:"首页";}i:1;a:8:{s:2:"id";s:8:"00000002";s:4:"name";s:6:"电话";s:3:"img";s:80:"'.$foot3.'";s:6:"actimg";s:80:"'.$foot4.'";s:3:"url";s:0:"";s:4:"type";s:3:"tel";s:9:"$$hashKey";s:9:"object:21";s:3:"tel";s:11:"13112345678";}i:2;a:9:{s:2:"id";s:15:"m01507451962587";s:3:"img";s:80:"'.$foot5.'";s:6:"actimg";s:80:"'.$foot6.'";s:3:"url";s:0:"";s:4:"name";s:6:"地图";s:4:"type";s:3:"map";s:9:"$$hashKey";s:9:"object:51";s:3:"lng";s:18:"114.05121803283691";s:3:"lat";s:18:"22.561628756102063";}i:3;a:7:{s:2:"id";s:15:"m11507451962587";s:3:"img";s:80:"'.$foot7.'";s:6:"actimg";s:80:"'.$foot8.'";s:3:"url";s:0:"";s:4:"name";s:6:"分享";s:4:"type";s:5:"share";s:9:"$$hashKey";s:9:"object:52";}}}'
			);
			pdo_insert('hyb_yl_bar',$bdata);
	...
	static function insertwlPage( $tid ){
		...
		if( $tid > 0 ){
			...
			$dd1 = $_W['siteroot'].'/addons/hyb_yl/public/images/wl_as1.jpg';
			$dd2 = $_W['siteroot'].'/addons/hyb_yl/public/images/wl_s4.jpg';
			$dd3 = $_W['siteroot'].'/addons/hyb_yl/public/images/wl_as3.jpg';

			$fx1 = $_W['siteroot'].'/addons/hyb_yl/public/images/wl_f1.jpg';
			$fx2 = $_W['siteroot'].'/addons/hyb_yl/public/images/wl_f2.jpg';
			$fx3 = $_W['siteroot'].'/addons/hyb_yl/public/images/wl_f3.jpg';
			$fx4 = $_W['siteroot'].'/addons/hyb_yl/public/images/wl_f4.jpg';

			$m1 = $_W['siteroot'].'/addons/hyb_yl/public/images/wl_m1.jpg';
			$m2 = $_W['siteroot'].'/addons/hyb_yl/public/images/wl_m2.jpg';
			$m3 = $_W['siteroot'].'/addons/hyb_yl/public/images/wl_m3.jpg';
			$m4 = $_W['siteroot'].'/addons/hyb_yl/public/images/wl_m4.jpg';
			$m5 = $_W['siteroot'].'/addons/hyb_yl/public/images/wl_m5.jpg';

			$xcx1 = $_W['siteroot'].'/addons/hyb_yl/public/images/wl_x1.jpg';
			$xcx2 = $_W['siteroot'].'/addons/hyb_yl/public/images/wl_d2.jpg';
			$xcx3 = $_W['siteroot'].'/addons/hyb_yl/public/images/wl_d3.jpg';
			$xcx4 = $_W['siteroot'].'/addons/hyb_yl/public/images/wl_d4.jpg';
			$xcx5 = $_W['siteroot'].'/addons/hyb_yl/public/images/wl_d5.jpg';
			$xcx6 = $_W['siteroot'].'/addons/hyb_yl/public/images/wl_d6.jpg';

			$index1 = $_W['siteroot'].'/addons/hyb_yl/public/images/wl_s1.jpg';
			$index2 = $_W['siteroot'].'/addons/hyb_yl/public/images/wl_s2.jpg';
			$index3 = $_W['siteroot'].'/addons/hyb_yl/public/images/wl_s3.png';
			$index4 = $_W['siteroot'].'/addons/hyb_yl/public/images/wl_s4.png';

			$index5 = $_W['siteroot'].'/addons/hyb_yl/public/images/wl_n1.png';
			$index6 = $_W['siteroot'].'/addons/hyb_yl/public/images/wl_n2.png';
			$index7 = $_W['siteroot'].'/addons/hyb_yl/public/images/wl_n3.png';
			$index8 = $_W['siteroot'].'/addons/hyb_yl/public/images/wl_n4.png';

			$index9 = $_W['siteroot'].'/addons/hyb_yl/public/images/wl_p1.png';
			$index10 = $_W['siteroot'].'/addons/hyb_yl/public/images/wl_p2.png';
			$index11 = $_W['siteroot'].'/addons/hyb_yl/public/images/wl_p3.png';
			$index12 = $_W['siteroot'].'/addons/hyb_yl/public/images/wl_p4.png';
			$index13 = $_W['siteroot'].'/addons/hyb_yl/public/images/wl_p5.png';
			$index14 = $_W['siteroot'].'/addons/hyb_yl/public/images/wl_p6.png';			

			$index15 = $_W['siteroot'].'/addons/hyb_yl/public/images/wl_ma1.jpg';
			$index16 = $_W['siteroot'].'/addons/hyb_yl/public/images/wl_ma2.jpg';			

			$foot1 = $_W['siteroot'].'/addons/hyb_yl/public/images/home1.png';
			$foot2 = $_W['siteroot'].'/addons/hyb_yl/public/images/home2.png';
			$foot3 = $_W['siteroot'].'/addons/hyb_yl/public/images/contact1.png';
			$foot4 = $_W['siteroot'].'/addons/hyb_yl/public/images/contact2.png';
			$foot5 = $_W['siteroot'].'/addons/hyb_yl/public/images/tel1.png';
			$foot6 = $_W['siteroot'].'/addons/hyb_yl/public/images/tel2.png';
			$foot7 = $_W['siteroot'].'/addons/hyb_yl/public/images/about1.png';
			$foot8 = $_W['siteroot'].'/addons/hyb_yl/public/images/about2.png';
...
div;
			...
			$params = <<<div
a:6:{s:3:"num";s:1:"4";s:7:"padding";s:1:"5";s:7:"bgcolor";s:7:"#ffffff";s:5:"color";s:4:"#999";s:8:"actcolor";s:7:"#ed414a";s:4:"data";a:4:{i:0;a:9:{s:2:"id";s:8:"00000001";s:4:"name";s:6:"首页";s:3:"img";s:80:"{$foot1}";s:6:"actimg";s:80:"{$foot2}";s:3:"url";s:38:"/hyb_yl/pages/page/page?pid={$indexid}";s:4:"type";s:3:"url";s:9:"$$hashKey";s:9:"object:20";s:6:"pageid";s:2:"{$indexid}";s:7:"urlname";s:6:"首页";}i:1;a:7:{s:2:"id";s:8:"00000002";s:4:"name";s:6:"咨询";s:3:"img";s:80:"{$foot3}";s:6:"actimg";s:80:"{$foot4}";s:3:"url";s:0:"";s:4:"type";s:4:"kefu";s:9:"$$hashKey";s:9:"object:21";}i:2;a:9:{s:2:"id";s:15:"m01507472225651";s:3:"img";s:80:"{$foot5}";s:6:"actimg";s:80:"{$foot6}";s:3:"url";s:38:"/hyb_yl/pages/page/page?pid={$contactid}";s:4:"name";s:12:"联系我们";s:4:"type";s:3:"url";s:9:"$$hashKey";s:9:"object:54";s:6:"pageid";s:2:"{$contactid}";s:7:"urlname";s:12:"联系我们";}i:3;a:9:{s:2:"id";s:15:"m11507472225651";s:3:"img";s:80:"{$foot7}";s:6:"actimg";s:80:"{$foot8}";s:3:"url";s:38:"/hyb_yl/pages/page/page?pid={$aboutid}";s:4:"name";s:12:"关于我们";s:4:"type";s:3:"url";s:9:"$$hashKey";s:9:"object:55";s:6:"pageid";s:2:"{$aboutid}";s:7:"urlname";s:12:"关于我们";}}}
div;
			$bdata = array(
				'uniacid' => $_W['uniacid'],
				'tempid' => $tid,
