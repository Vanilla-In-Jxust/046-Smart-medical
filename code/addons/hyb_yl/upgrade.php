...
pdo_query("CREATE TABLE IF NOT EXISTS `ims_hyb_yl_address` (
  ...
  `status` tinyint(2) NOT NULL COMMENT 's会否开启',
...
if(!pdo_fieldexists('hyb_yl_address','pid')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_address')." ADD   `pid` int(11) unsigned NOT NULL");}
if(!pdo_fieldexists('hyb_yl_address','name')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_address')." ADD   `name` varchar(500) NOT NULL");}
...
if(!pdo_fieldexists('hyb_yl_address','level')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_address')." ADD   `level` tinyint(3) unsigned NOT NULL");}
if(!pdo_fieldexists('hyb_yl_address','is_host')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_address')." ADD   `is_host` tinyint(2) NOT NULL");}
if(!pdo_fieldexists('hyb_yl_address','status')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_address')." ADD   `status` tinyint(2) NOT NULL COMMENT 's会否开启'");}
...
if(!pdo_fieldexists('hyb_yl_address','created')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_address')." ADD   `created` int(11) NOT NULL");}
...
if(!pdo_fieldexists('hyb_yl_all_server_menulist','ser_url')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_all_server_menulist')." ADD   `ser_url` varchar(255) NOT NULL");}
pdo_query("CREATE TABLE IF NOT EXISTS `ims_hyb_yl_answer` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=426 DEFAULT CHARSET=utf8 COMMENT='问题表';
...
if(!pdo_fieldexists('hyb_yl_attention','id')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_attention')." ADD 
  `id` int(11) NOT NULL AUTO_INCREMENT");}
if(!pdo_fieldexists('hyb_yl_attention','goods_id')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_attention')." ADD   `goods_id` int(11) NOT NULL");}
if(!pdo_fieldexists('hyb_yl_attention','openid')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_attention')." ADD   `openid` varchar(255) NOT NULL");}
if(!pdo_fieldexists('hyb_yl_attention','cerated_time')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_attention')." ADD   `cerated_time` datetime NOT NULL");}
...
if(!pdo_fieldexists('hyb_yl_attention','beizhu')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_attention')." ADD   `beizhu` char(50) NOT NULL");}
...
if(!pdo_fieldexists('hyb_yl_backorders','ordersn')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_backorders')." ADD 
  `ordersn` varchar(255) NOT NULL DEFAULT ''");}
if(!pdo_fieldexists('hyb_yl_backorders','status')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_backorders')." ADD   `status` varchar(255) NOT NULL DEFAULT ''");}
if(!pdo_fieldexists('hyb_yl_backorders','createtime')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_backorders')." ADD   `createtime` varchar(255) NOT NULL DEFAULT ''");}
...
if(!pdo_fieldexists('hyb_yl_baogao_setting','is_shenhe')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_baogao_setting')." ADD   `is_shenhe` int(10) NOT NULL COMMENT '是否免审核（0：否；1：是）'");}
...
if(!pdo_fieldexists('hyb_yl_baogaopinglunsite','pl_text')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_baogaopinglunsite')." ADD   `pl_text` text NOT NULL");}
if(!pdo_fieldexists('hyb_yl_baogaopinglunsite','pl_time')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_baogaopinglunsite')." ADD   `pl_time` int(11) NOT NULL");}
if(!pdo_fieldexists('hyb_yl_baogaopinglunsite','dengj')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_baogaopinglunsite')." ADD   `dengj` tinyint(11) NOT NULL");}
if(!pdo_fieldexists('hyb_yl_baogaopinglunsite','parentid')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_baogaopinglunsite')." ADD   `parentid` int(11) NOT NULL");}
if(!pdo_fieldexists('hyb_yl_baogaopinglunsite','usertoux')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_baogaopinglunsite')." ADD   `usertoux` varchar(255) NOT NULL");}
if(!pdo_fieldexists('hyb_yl_baogaopinglunsite','name')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_baogaopinglunsite')." ADD   `name` char(50) NOT NULL");}
...
if(!pdo_fieldexists('hyb_yl_base','show_title')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_base')." ADD   `show_title` varchar(255) NOT NULL COMMENT '标题'");}
...
if(!pdo_fieldexists('hyb_yl_base','advertisement')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_base')." ADD   `advertisement` text NOT NULL");}
if(!pdo_fieldexists('hyb_yl_base','back_zjthumb')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_base')." ADD   `back_zjthumb` text NOT NULL");}
if(!pdo_fieldexists('hyb_yl_base','tj_thumb')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_base')." ADD   `tj_thumb` varchar(255) NOT NULL");}
if(!pdo_fieldexists('hyb_yl_base','ztcolor')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_base')." ADD   `ztcolor` varchar(50) NOT NULL");}
...
if(!pdo_fieldexists('hyb_yl_base','yy_thumb')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_base')." ADD   `yy_thumb` varchar(255) NOT NULL");}
...
pdo_query("CREATE TABLE IF NOT EXISTS `ims_hyb_yl_card_rule` (
  ...
  `created` int(11) NOT NULL COMMENT '添加时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='年卡规则表';
...
if(!pdo_fieldexists('hyb_yl_ceshi','id')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_ceshi')." ADD 
  `id` int(11) NOT NULL AUTO_INCREMENT");}
if(!pdo_fieldexists('hyb_yl_ceshi','name')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_ceshi')." ADD   `name` varchar(255) NOT NULL");}
if(!pdo_fieldexists('hyb_yl_ceshi','uniacid')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_ceshi')." ADD   `uniacid` int(11) NOT NULL");}
if(!pdo_fieldexists('hyb_yl_ceshi','description')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_ceshi')." ADD   `description` varchar(255) NOT NULL");}
if(!pdo_fieldexists('hyb_yl_ceshi','detail_cover_url')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_ceshi')." ADD   `detail_cover_url` varchar(255) NOT NULL");}
if(!pdo_fieldexists('hyb_yl_ceshi','color')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_ceshi')." ADD   `color` varchar(50) NOT NULL");}
...
if(!pdo_fieldexists('hyb_yl_ceshi','sort')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_ceshi')." ADD   `sort` tinyint(11) NOT NULL DEFAULT '0'");}
if(!pdo_fieldexists('hyb_yl_ceshi','giftstatus')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_ceshi')." ADD   `giftstatus` varchar(11) NOT NULL");}
...
if(!pdo_fieldexists('hyb_yl_chufang','time')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_chufang')." ADD   `time` int(11) NOT NULL");}
...
if(!pdo_fieldexists('hyb_yl_chufang_log','paytime')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_chufang_log')." ADD   `paytime` int(11) NOT NULL COMMENT '支付时间'");}
...
if(!pdo_fieldexists('hyb_yl_chufang_log','kftime')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_chufang_log')." ADD   `kftime` int(11) NOT NULL");}
...
if(!pdo_fieldexists('hyb_yl_classgory','ctname')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_classgory')." ADD   `ctname` varchar(50) NOT NULL");}
...
if(!pdo_fieldexists('hyb_yl_doc_all_serverlist','zid')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_doc_all_serverlist')." ADD   `zid` int(11) NOT NULL");}
...
if(!pdo_fieldexists('hyb_yl_docjobtime','server_time')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_docjobtime')." ADD   `server_time` text NOT NULL");}
if(!pdo_fieldexists('hyb_yl_docjobtime','nums')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_docjobtime')." ADD   `nums` int(11) NOT NULL");}
if(!pdo_fieldexists('hyb_yl_docjobtime','title')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_docjobtime')." ADD   `title` varchar(255) NOT NULL");}
if(!pdo_fieldexists('hyb_yl_docjobtime','state')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_docjobtime')." ADD   `state` tinyint(11) NOT NULL");}
if(!pdo_fieldexists('hyb_yl_docjobtime','zid')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_docjobtime')." ADD   `zid` int(11) NOT NULL");}
...
if(!pdo_fieldexists('hyb_yl_docser_speck','thumb')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_docser_speck')." ADD   `thumb` varchar(255) NOT NULL");}
if(!pdo_fieldexists('hyb_yl_docser_speck','sort')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_docser_speck')." ADD   `sort` int(11) NOT NULL");}
if(!pdo_fieldexists('hyb_yl_docser_speck','titlme')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_docser_speck')." ADD   `titlme` varchar(255) NOT NULL");}
if(!pdo_fieldexists('hyb_yl_docser_speck','icon')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_docser_speck')." ADD   `icon` varchar(255) NOT NULL");}
if(!pdo_fieldexists('hyb_yl_docser_speck','url')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_docser_speck')." ADD   `url` varchar(255) NOT NULL");}
if(!pdo_fieldexists('hyb_yl_docser_speck','state')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_docser_speck')." ADD   `state` tinyint(2) NOT NULL");}
if(!pdo_fieldexists('hyb_yl_docser_speck','server_content')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_docser_speck')." ADD   `server_content` text NOT NULL");}
...
if(!pdo_fieldexists('hyb_yl_docser_speck','time')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_docser_speck')." ADD   `time` varchar(255) NOT NULL");}
if(!pdo_fieldexists('hyb_yl_docser_speck','ftitle')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_docser_speck')." ADD   `ftitle` varchar(255) NOT NULL");}
...
if(!pdo_fieldexists('hyb_yl_docserver','zid')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_docserver')." ADD   `zid` int(11) NOT NULL");}
if(!pdo_fieldexists('hyb_yl_docserver','sid')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_docserver')." ADD   `sid` int(11) NOT NULL");}
if(!pdo_fieldexists('hyb_yl_docserver','state')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_docserver')." ADD   `state` int(11) NOT NULL");}
...
if(!pdo_fieldexists('hyb_yl_docserver','pinyin')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_docserver')." ADD   `pinyin` varchar(255) NOT NULL");}
pdo_query("CREATE TABLE IF NOT EXISTS `ims_hyb_yl_docserver_type` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL,
  `title` varchar(50) NOT NULL,
  `time_leng` int(11) NOT NULL,
  `money` float(7,2) NOT NULL,
  `typeid` int(11) NOT NULL,
  `stort` int(11) NOT NULL,
  `fx_type` tinyint(2) NOT NULL DEFAULT '1' COMMENT '0参与1不参与',
  `one_fx` varchar(50) NOT NULL,
  `two_tx` varchar(50) NOT NULL,
...
if(!pdo_fieldexists('hyb_yl_docserver_type','title')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_docserver_type')." ADD   `title` varchar(50) NOT NULL");}
if(!pdo_fieldexists('hyb_yl_docserver_type','time_leng')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_docserver_type')." ADD   `time_leng` int(11) NOT NULL");}
if(!pdo_fieldexists('hyb_yl_docserver_type','money')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_docserver_type')." ADD   `money` float(7,2) NOT NULL");}
if(!pdo_fieldexists('hyb_yl_docserver_type','typeid')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_docserver_type')." ADD   `typeid` int(11) NOT NULL");}
if(!pdo_fieldexists('hyb_yl_docserver_type','stort')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_docserver_type')." ADD   `stort` int(11) NOT NULL");}
...
if(!pdo_fieldexists('hyb_yl_docserver_type','one_fx')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_docserver_type')." ADD   `one_fx` varchar(50) NOT NULL");}
if(!pdo_fieldexists('hyb_yl_docserver_type','two_tx')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_docserver_type')." ADD   `two_tx` varchar(50) NOT NULL");}
...
pdo_query("CREATE TABLE IF NOT EXISTS `ims_hyb_yl_duanxin` (
  ...
  `scret` varchar(50) NOT NULL,
  `qianming` varchar(50) NOT NULL,
  `moban_id` text NOT NULL,
...
if(!pdo_fieldexists('hyb_yl_duanxin','key')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_duanxin')." ADD   `key` varchar(50) NOT NULL");}
if(!pdo_fieldexists('hyb_yl_duanxin','scret')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_duanxin')." ADD   `scret` varchar(50) NOT NULL");}
if(!pdo_fieldexists('hyb_yl_duanxin','qianming')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_duanxin')." ADD   `qianming` varchar(50) NOT NULL");}
if(!pdo_fieldexists('hyb_yl_duanxin','moban_id')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_duanxin')." ADD   `moban_id` text NOT NULL");}
...
if(!pdo_fieldexists('hyb_yl_duanxin','stadus')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_duanxin')." ADD   `stadus` int(11) NOT NULL DEFAULT '0'");}
if(!pdo_fieldexists('hyb_yl_duanxin','tel')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_duanxin')." ADD   `tel` varchar(50) NOT NULL");}
...
pdo_query("CREATE TABLE IF NOT EXISTS `ims_hyb_yl_duibi_rule` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='对比规则表';
...
pdo_query("CREATE TABLE IF NOT EXISTS `ims_hyb_yl_fwlist` (
  ...
  `fw_pic` varchar(255) NOT NULL,
  `fw_xy` longtext NOT NULL,
  `pid` int(11) NOT NULL,
  `fw_money` float(8,2) NOT NULL,
  `fw_startime` int(11) NOT NULL,
  `fw_endtime` int(11) NOT NULL,
  `fw_neirong` varchar(255) NOT NULL,
  PRIMARY KEY (`ff_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
if(!pdo_fieldexists('hyb_yl_fwlist','fw_name')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_fwlist')." ADD   `fw_name` varchar(255) NOT NULL");}
if(!pdo_fieldexists('hyb_yl_fwlist','fw_pic')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_fwlist')." ADD   `fw_pic` varchar(255) NOT NULL");}
if(!pdo_fieldexists('hyb_yl_fwlist','fw_xy')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_fwlist')." ADD   `fw_xy` longtext NOT NULL");}
if(!pdo_fieldexists('hyb_yl_fwlist','pid')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_fwlist')." ADD   `pid` int(11) NOT NULL");}
if(!pdo_fieldexists('hyb_yl_fwlist','fw_money')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_fwlist')." ADD   `fw_money` float(8,2) NOT NULL");}
if(!pdo_fieldexists('hyb_yl_fwlist','fw_startime')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_fwlist')." ADD   `fw_startime` int(11) NOT NULL");}
if(!pdo_fieldexists('hyb_yl_fwlist','fw_endtime')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_fwlist')." ADD   `fw_endtime` int(11) NOT NULL");}
if(!pdo_fieldexists('hyb_yl_fwlist','fw_neirong')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_fwlist')." ADD   `fw_neirong` varchar(255) NOT NULL");}
...
pdo_query("CREATE TABLE IF NOT EXISTS `ims_hyb_yl_gh_rule` (
  ...
  `created` int(11) NOT NULL COMMENT '添加时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='挂号规则表';
...
pdo_query("CREATE TABLE IF NOT EXISTS `ims_hyb_yl_ghyy_type` (
  ...
  `created` int(11) NOT NULL COMMENT '添加时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='挂号预约类型表';
...
pdo_query("CREATE TABLE IF NOT EXISTS `ims_hyb_yl_goodsorders` (
  ...
  `y_id` int(11) DEFAULT NULL COMMENT '药师id',
...
if(!pdo_fieldexists('hyb_yl_goodsorders','feight')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_goodsorders')." ADD   `feight` decimal(11,3) NOT NULL");}
if(!pdo_fieldexists('hyb_yl_goodsorders','num')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_goodsorders')." ADD   `num` int(11) NOT NULL");}
...
if(!pdo_fieldexists('hyb_yl_goodsorders','openid')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_goodsorders')." ADD   `openid` varchar(255) NOT NULL");}
if(!pdo_fieldexists('hyb_yl_goodsorders','paytime')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_goodsorders')." ADD   `paytime` datetime NOT NULL");}
...
if(!pdo_fieldexists('hyb_yl_goodsorders','overtime')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_goodsorders')." ADD   `overtime` int(11) NOT NULL");}
if(!pdo_fieldexists('hyb_yl_goodsorders','key_words')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_goodsorders')." ADD   `key_words` varchar(50) NOT NULL");}
...
if(!pdo_fieldexists('hyb_yl_goodsorders','y_id')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_goodsorders')." ADD   `y_id` int(11) DEFAULT NULL COMMENT '药师id'");}
if(!pdo_fieldexists('hyb_yl_goodsorders','sh_time')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_goodsorders')." ADD   `sh_time` int(11) DEFAULT NULL COMMENT '审核时间'");}
...
pdo_query("CREATE TABLE IF NOT EXISTS `ims_hyb_yl_guahaoorder` (
  ...
  `thtime` varchar(255) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='挂号订单表';
...
if(!pdo_fieldexists('hyb_yl_guatime','shengyunus')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_guatime')." ADD   `shengyunus` varchar(255) DEFAULT NULL");}
...
if(!pdo_fieldexists('hyb_yl_guatime','nums')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_guatime')." ADD   `nums` varchar(255) DEFAULT NULL");}
...
pdo_query("CREATE TABLE IF NOT EXISTS `ims_hyb_yl_guidance` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='导诊员列表';
...
pdo_query("CREATE TABLE IF NOT EXISTS `ims_hyb_yl_guidance_order` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=24 DEFAULT CHARSET=utf8 COMMENT='导诊订单表';
...
pdo_query("CREATE TABLE IF NOT EXISTS `ims_hyb_yl_hjiaosite` (
  ...
  `h_video` varchar(255) NOT NULL,
  `h_type` int(11) NOT NULL DEFAULT '1' COMMENT '1平台0专家',
  `h_text` text NOT NULL,
  `h_dianzan` int(11) unsigned NOT NULL,
  `h_read` int(11) unsigned NOT NULL,
  `h_zhuanfa` int(11) unsigned NOT NULL,
...
if(!pdo_fieldexists('hyb_yl_hjiaosite','h_title')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_hjiaosite')." ADD   `h_title` varchar(255) NOT NULL");}
if(!pdo_fieldexists('hyb_yl_hjiaosite','h_pic')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_hjiaosite')." ADD   `h_pic` varchar(255) NOT NULL");}
if(!pdo_fieldexists('hyb_yl_hjiaosite','h_video')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_hjiaosite')." ADD   `h_video` varchar(255) NOT NULL");}
...
if(!pdo_fieldexists('hyb_yl_hjiaosite','h_text')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_hjiaosite')." ADD   `h_text` text NOT NULL");}
if(!pdo_fieldexists('hyb_yl_hjiaosite','h_dianzan')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_hjiaosite')." ADD   `h_dianzan` int(11) unsigned NOT NULL");}
if(!pdo_fieldexists('hyb_yl_hjiaosite','h_read')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_hjiaosite')." ADD   `h_read` int(11) unsigned NOT NULL");}
if(!pdo_fieldexists('hyb_yl_hjiaosite','h_zhuanfa')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_hjiaosite')." ADD   `h_zhuanfa` int(11) unsigned NOT NULL");}
...
if(!pdo_fieldexists('hyb_yl_hjiaosite','zid')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_hjiaosite')." ADD   `zid` int(11) NOT NULL DEFAULT '0'");}
...
if(!pdo_fieldexists('hyb_yl_hjiaosite','audios')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_hjiaosite')." ADD   `audios` varchar(255) NOT NULL");}
if(!pdo_fieldexists('hyb_yl_hjiaosite','uid')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_hjiaosite')." ADD   `uid` int(11) NOT NULL");}
...
pdo_query("CREATE TABLE IF NOT EXISTS `ims_hyb_yl_hospital` (
  ...
  `backpassword` varchar(255) NOT NULL,
  ...
  `districtslevel` tinyint(11) NOT NULL,
...
if(!pdo_fieldexists('hyb_yl_hospital','agentname')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_hospital')." ADD   `agentname` varchar(255) NOT NULL");}
...
if(!pdo_fieldexists('hyb_yl_hospital','zctime')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_hospital')." ADD   `zctime` int(11) NOT NULL");}
if(!pdo_fieldexists('hyb_yl_hospital','backpassword')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_hospital')." ADD   `backpassword` varchar(255) NOT NULL");}
...
if(!pdo_fieldexists('hyb_yl_hospital','city')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_hospital')." ADD   `city` int(11) NOT NULL");}
if(!pdo_fieldexists('hyb_yl_hospital','district')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_hospital')." ADD   `district` int(11) NOT NULL");}
...
if(!pdo_fieldexists('hyb_yl_hospital','districtslevel')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_hospital')." ADD   `districtslevel` tinyint(11) NOT NULL");}
...
if(!pdo_fieldexists('hyb_yl_hospital_diction','name')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_hospital_diction')." ADD   `name` varchar(255) NOT NULL");}
...
if(!pdo_fieldexists('hyb_yl_hospital_diction','grouparr')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_hospital_diction')." ADD   `grouparr` varchar(255) NOT NULL");}
pdo_query("CREATE TABLE IF NOT EXISTS `ims_hyb_yl_hospital_level` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL,
  `level_name` varchar(255) NOT NULL,
  `level_strot` int(11) NOT NULL,
...
if(!pdo_fieldexists('hyb_yl_hospital_level','level_name')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_hospital_level')." ADD   `level_name` varchar(255) NOT NULL");}
if(!pdo_fieldexists('hyb_yl_hospital_level','level_strot')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_hospital_level')." ADD   `level_strot` int(11) NOT NULL");}
...
if(!pdo_fieldexists('hyb_yl_hospitaljobtime','server_time')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_hospitaljobtime')." ADD   `server_time` text NOT NULL");}
if(!pdo_fieldexists('hyb_yl_hospitaljobtime','nums')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_hospitaljobtime')." ADD   `nums` int(11) NOT NULL");}
if(!pdo_fieldexists('hyb_yl_hospitaljobtime','title')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_hospitaljobtime')." ADD   `title` varchar(255) NOT NULL");}
if(!pdo_fieldexists('hyb_yl_hospitaljobtime','state')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_hospitaljobtime')." ADD   `state` tinyint(11) NOT NULL");}
...
pdo_query("CREATE TABLE IF NOT EXISTS `ims_hyb_yl_jiesuan_set` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='结算设置';
...
if(!pdo_fieldexists('hyb_yl_label_library','name')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_label_library')." ADD   `name` varchar(255) DEFAULT NULL");}
if(!pdo_fieldexists('hyb_yl_label_library','status')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_label_library')." ADD   `status` int(10) NOT NULL DEFAULT '0'");}
if(!pdo_fieldexists('hyb_yl_label_library','sort')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_label_library')." ADD   `sort` int(10) NOT NULL DEFAULT '0'");}
...
pdo_query("CREATE TABLE IF NOT EXISTS `ims_hyb_yl_menu_array` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL,
  `footers_menu` text NOT NULL,
  `server_menu` text NOT NULL,
  `doc_server` text NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8;
...
if(!pdo_fieldexists('hyb_yl_menu_array','footers_menu')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_menu_array')." ADD   `footers_menu` text NOT NULL");}
if(!pdo_fieldexists('hyb_yl_menu_array','server_menu')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_menu_array')." ADD   `server_menu` text NOT NULL");}
if(!pdo_fieldexists('hyb_yl_menu_array','doc_server')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_menu_array')." ADD   `doc_server` text NOT NULL");}
...
if(!pdo_fieldexists('hyb_yl_menulist','name')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_menulist')." ADD   `name` varchar(50) NOT NULL");}
if(!pdo_fieldexists('hyb_yl_menulist','icon')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_menulist')." ADD   `icon` varchar(255) NOT NULL");}
...
if(!pdo_fieldexists('hyb_yl_menulist','url')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_menulist')." ADD   `url` varchar(255) NOT NULL");}
...
pdo_query("CREATE TABLE IF NOT EXISTS `ims_hyb_yl_mycenter` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=93 DEFAULT CHARSET=utf8 COMMENT='个人中心菜单表';
...
pdo_query("CREATE TABLE IF NOT EXISTS `ims_hyb_yl_parameter` (
  ...
  `pub_appid` varchar(255) NOT NULL COMMENT 'g公众号appid',
  `pub_api` varchar(255) NOT NULL COMMENT '公众号支付秘钥',
  `appkey` varchar(255) NOT NULL COMMENT '公众号秘钥',
...
if(!pdo_fieldexists('hyb_yl_parameter','pub_appid')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_parameter')." ADD   `pub_appid` varchar(255) NOT NULL COMMENT 'g公众号appid'");}
...
if(!pdo_fieldexists('hyb_yl_parameter','appkey')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_parameter')." ADD   `appkey` varchar(255) NOT NULL COMMENT '公众号秘钥'");}
...
if(!pdo_fieldexists('hyb_yl_parameter','huaw_key')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_parameter')." ADD   `huaw_key` varchar(255) NOT NULL");}
...
pdo_query("CREATE TABLE IF NOT EXISTS `ims_hyb_yl_pay` (
  ...
  `style` tinyint(2) NOT NULL DEFAULT '0' COMMENT '收支类型（0：导诊；1：专家；2：团队；3：代理；4：分销；5：用户;6:药师）',
  `status` tinyint(2) NOT NULL DEFAULT '0' COMMENT '状态（0；待审核；1：审核通过；2：审核拒绝）',
  `cash` tinyint(2) DEFAULT '1' COMMENT '是否为提现（0：否；1：是）',
  `tid` int(11) NOT NULL,
  `cash_type` tinyint(2) NOT NULL DEFAULT '0' COMMENT '提现方式（0：微信；1：支付宝；2：银行卡）',
  `yid` int(11) DEFAULT NULL COMMENT '药师id',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8 COMMENT='收支明细表';
...
if(!pdo_fieldexists('hyb_yl_pay','keyword')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_pay')." ADD   `keyword` varchar(255) DEFAULT NULL");}
...
if(!pdo_fieldexists('hyb_yl_pay','style')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_pay')." ADD   `style` tinyint(2) NOT NULL DEFAULT '0' COMMENT '收支类型（0：导诊；1：专家；2：团队；3：代理；4：分销；5：用户;6:药师）'");}
...
if(!pdo_fieldexists('hyb_yl_pay','cash')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_pay')." ADD   `cash` tinyint(2) DEFAULT '1' COMMENT '是否为提现（0：否；1：是）'");}
if(!pdo_fieldexists('hyb_yl_pay','tid')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_pay')." ADD   `tid` int(11) NOT NULL");}
...
if(!pdo_fieldexists('hyb_yl_pay','yid')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_pay')." ADD   `yid` int(11) DEFAULT NULL COMMENT '药师id'");}
...
if(!pdo_fieldexists('hyb_yl_pingjia','j_id')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_pingjia')." ADD   `j_id` int(11) NOT NULL");}
...
if(!pdo_fieldexists('hyb_yl_pinglunsite','sid')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_pinglunsite')." ADD   `sid` int(11) NOT NULL");}
if(!pdo_fieldexists('hyb_yl_pinglunsite','pl_text')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_pinglunsite')." ADD   `pl_text` text NOT NULL");}
if(!pdo_fieldexists('hyb_yl_pinglunsite','pl_time')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_pinglunsite')." ADD   `pl_time` int(11) NOT NULL");}
if(!pdo_fieldexists('hyb_yl_pinglunsite','dengj')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_pinglunsite')." ADD   `dengj` tinyint(11) NOT NULL");}
if(!pdo_fieldexists('hyb_yl_pinglunsite','parentid')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_pinglunsite')." ADD   `parentid` int(11) NOT NULL");}
if(!pdo_fieldexists('hyb_yl_pinglunsite','usertoux')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_pinglunsite')." ADD   `usertoux` varchar(255) NOT NULL");}
if(!pdo_fieldexists('hyb_yl_pinglunsite','name')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_pinglunsite')." ADD   `name` char(50) NOT NULL");}
...
if(!pdo_fieldexists('hyb_yl_qianyueorder','openid')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_qianyueorder')." ADD   `openid` varchar(255) NOT NULL");}
...
if(!pdo_fieldexists('hyb_yl_qyfwneirng','addtime')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_qyfwneirng')." ADD   `addtime` int(11) NOT NULL");}
...
pdo_query("CREATE TABLE IF NOT EXISTS `ims_hyb_yl_refund` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COMMENT='退款记录表';
...
if(!pdo_fieldexists('hyb_yl_schoolroom','room_video')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_schoolroom')." ADD   `room_video` varchar(255) NOT NULL");}
...
if(!pdo_fieldexists('hyb_yl_schoolroom','openid')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_schoolroom')." ADD   `openid` varchar(11) NOT NULL");}
...
if(!pdo_fieldexists('hyb_yl_search','name')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_search')." ADD   `name` varchar(255) DEFAULT NULL");}
if(!pdo_fieldexists('hyb_yl_search','status')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_search')." ADD   `status` int(10) NOT NULL DEFAULT '0'");}
if(!pdo_fieldexists('hyb_yl_search','sort')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_search')." ADD   `sort` int(10) NOT NULL DEFAULT '0'");}
...
pdo_query("CREATE TABLE IF NOT EXISTS `ims_hyb_yl_service_homepage` (
  ...
  `serh_thumb` varchar(255) NOT NULL,
...
if(!pdo_fieldexists('hyb_yl_service_homepage','serh_thumb')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_service_homepage')." ADD   `serh_thumb` varchar(255) NOT NULL");}
...
if(!pdo_fieldexists('hyb_yl_share','openid')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_share')." ADD   `openid` varchar(255) NOT NULL");}
...
if(!pdo_fieldexists('hyb_yl_share','shartitle')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_share')." ADD   `shartitle` varchar(50) NOT NULL");}
...
pdo_query("CREATE TABLE IF NOT EXISTS `ims_hyb_yl_shoufei_set` (
  ...
  `sort` int(11) NOT NULL COMMENT '排序',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8 COMMENT='收费设置表';
...
if(!pdo_fieldexists('hyb_yl_store_sale','stord')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_store_sale')." ADD   `stord` int(11) DEFAULT '0'");}
if(!pdo_fieldexists('hyb_yl_store_sale','title')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_store_sale')." ADD   `title` varchar(255) DEFAULT ''");}
if(!pdo_fieldexists('hyb_yl_store_sale','intro')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_store_sale')." ADD   `intro` varchar(500) DEFAULT ''");}
...
if(!pdo_fieldexists('hyb_yl_store_sale','addtime')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_store_sale')." ADD   `addtime` int(11) NOT NULL");}
pdo_query("CREATE TABLE IF NOT EXISTS `ims_hyb_yl_tank` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2172 DEFAULT CHARSET=utf8 COMMENT='智库列表';
...
pdo_query("CREATE TABLE IF NOT EXISTS `ims_hyb_yl_taocan` (
  ...
  `fx_one` varchar(20) NOT NULL COMMENT '一级分销结算金额',
  `fx_two` varchar(20) NOT NULL COMMENT '二级分销结算金额',
...
if(!pdo_fieldexists('hyb_yl_taocan','fx_one')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_taocan')." ADD   `fx_one` varchar(20) NOT NULL COMMENT '一级分销结算金额'");}
if(!pdo_fieldexists('hyb_yl_taocan','fx_two')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_taocan')." ADD   `fx_two` varchar(20) NOT NULL COMMENT '二级分销结算金额'");}
...
pdo_query("CREATE TABLE IF NOT EXISTS `ims_hyb_yl_team` (
  ...
  `z_sex` tinyint(2) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COMMENT='团队表';
...
if(!pdo_fieldexists('hyb_yl_team','z_sex')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_team')." ADD   `z_sex` tinyint(2) NOT NULL DEFAULT '0'");}
pdo_query("CREATE TABLE IF NOT EXISTS `ims_hyb_yl_team_people` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL,
  `tid` int(11) NOT NULL COMMENT '团队id',
  `openid` varchar(11) DEFAULT NULL COMMENT '邀请用户openid',
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8 COMMENT='团队用户表';
...
if(!pdo_fieldexists('hyb_yl_team_people','openid')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_team_people')." ADD   `openid` varchar(11) DEFAULT NULL COMMENT '邀请用户openid'");}
...
pdo_query("CREATE TABLE IF NOT EXISTS `ims_hyb_yl_team_serverlist` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=89 DEFAULT CHARSET=utf8 COMMENT='团队服务表';
...
if(!pdo_fieldexists('hyb_yl_teamment','title')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_teamment')." ADD   `title` char(50) NOT NULL");}
if(!pdo_fieldexists('hyb_yl_teamment','teamtext')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_teamment')." ADD   `teamtext` text NOT NULL");}
if(!pdo_fieldexists('hyb_yl_teamment','thumbarr')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_teamment')." ADD   `thumbarr` varchar(255) NOT NULL");}
...
if(!pdo_fieldexists('hyb_yl_teamment','updateTime')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_teamment')." ADD   `updateTime` int(11) NOT NULL");}
pdo_query("CREATE TABLE IF NOT EXISTS `ims_hyb_yl_teamorder` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=25 DEFAULT CHARSET=utf8 COMMENT='团队订单表';
...
pdo_query("CREATE TABLE IF NOT EXISTS `ims_hyb_yl_tijian_moban` (
  ...
  `status` tinyint(2) NOT NULL DEFAULT '1' COMMENT '状态（0：禁用；1：启用）',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8 COMMENT='体检模板表';
...
pdo_query("CREATE TABLE IF NOT EXISTS `ims_hyb_yl_tijianorder` (
  ...
  `ifpay` int(11) NOT NULL DEFAULT '0' COMMENT '0待支付1已支付待接诊2接诊中3已完成4待评价5已评价6：申请退款；7：同意退款；8：拒绝退款',
  `yy_time` varchar(255) NOT NULL,
...
if(!pdo_fieldexists('hyb_yl_tijianorder','money')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_tijianorder')." ADD   `money` float(8,2) NOT NULL");}
if(!pdo_fieldexists('hyb_yl_tijianorder','content')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_tijianorder')." ADD   `content` text NOT NULL");}
...
if(!pdo_fieldexists('hyb_yl_tijianorder','time')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_tijianorder')." ADD   `time` int(11) NOT NULL");}
...
if(!pdo_fieldexists('hyb_yl_tijianorder','ifpay')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_tijianorder')." ADD   `ifpay` int(11) NOT NULL DEFAULT '0' COMMENT '0待支付1已支付待接诊2接诊中3已完成4待评价5已评价6：申请退款；7：同意退款；8：拒绝退款'");}
if(!pdo_fieldexists('hyb_yl_tijianorder','yy_time')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_tijianorder')." ADD   `yy_time` varchar(255) NOT NULL");}
...
if(!pdo_fieldexists('hyb_yl_tijianorder','openid')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_tijianorder')." ADD   `openid` varchar(255) NOT NULL");}
...
if(!pdo_fieldexists('hyb_yl_tijianorder','pdf')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_tijianorder')." ADD   `pdf` varchar(255) NOT NULL");}
...
if(!pdo_fieldexists('hyb_yl_tijianorder','jztime')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_tijianorder')." ADD   `jztime` datetime NOT NULL");}
...
if(!pdo_fieldexists('hyb_yl_tjyytime','shengyunus')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_tjyytime')." ADD   `shengyunus` varchar(255) DEFAULT NULL");}
...
if(!pdo_fieldexists('hyb_yl_tjyytime','nums')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_tjyytime')." ADD   `nums` varchar(255) DEFAULT NULL");}
if(!pdo_fieldexists('hyb_yl_tjyytime','time')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_tjyytime')." ADD   `time` varchar(255) DEFAULT NULL");}
...
pdo_query("CREATE TABLE IF NOT EXISTS `ims_hyb_yl_tuiguanglog` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL,
  `type` tinyint(11) NOT NULL COMMENT '1人数2患者3机构4进入专家主页',
...
if(!pdo_fieldexists('hyb_yl_tuiguanglog','type')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_tuiguanglog')." ADD   `type` tinyint(11) NOT NULL COMMENT '1人数2患者3机构4进入专家主页'");}
...
if(!pdo_fieldexists('hyb_yl_tuiguanglog','zid')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_tuiguanglog')." ADD   `zid` int(11) NOT NULL");}
...
pdo_query("CREATE TABLE IF NOT EXISTS `ims_hyb_yl_tuihospital` (
  ...
  `openid` varchar(255) NOT NULL,
  `addtime` int(11) NOT NULL,
  `shar_num` int(10) unsigned NOT NULL DEFAULT '1',
  `useropenid` varchar(255) NOT NULL,
...
if(!pdo_fieldexists('hyb_yl_tuihospital','hid')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_tuihospital')." ADD   `hid` int(11) NOT NULL");}
if(!pdo_fieldexists('hyb_yl_tuihospital','openid')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_tuihospital')." ADD   `openid` varchar(255) NOT NULL");}
if(!pdo_fieldexists('hyb_yl_tuihospital','addtime')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_tuihospital')." ADD   `addtime` int(11) NOT NULL");}
if(!pdo_fieldexists('hyb_yl_tuihospital','shar_num')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_tuihospital')." ADD   `shar_num` int(10) unsigned NOT NULL DEFAULT '1'");}
...
pdo_query("CREATE TABLE IF NOT EXISTS `ims_hyb_yl_tuike_roul` (
  ...
  `ranknum` tinyint(2) NOT NULL,
  `levelshow` tinyint(2) NOT NULL,
  `seetstatus` tinyint(2) NOT NULL,
  `slide_thumb` varchar(255) NOT NULL COMMENT '幻灯片',
  `lowestmoney` float(8,2) NOT NULL,
  ...
  `applymoney` float(8,2) NOT NULL,
  `modeonemoney` float(8,2) NOT NULL,
  `modetwomoney` float(8,2) NOT NULL,
  `examine` tinyint(2) NOT NULL COMMENT '是否审核',
  `twoappdis` tinyint(3) NOT NULL COMMENT '二级分销商条件',
  `twoapplymoney` float(8,2) NOT NULL,
  `onegetmoney` float(8,2) NOT NULL,
  `twoexamine` tinyint(2) NOT NULL COMMENT '二级是否审核',
  `bindvip` tinyint(3) NOT NULL,
  `lockstatus` tinyint(2) NOT NULL COMMENT '绑定上下级关系条件',
  `showlock` tinyint(2) NOT NULL COMMENT '是否显示未锁定下级',
...
if(!pdo_fieldexists('hyb_yl_tuike_roul','switch')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_tuike_roul')." ADD   `switch` tinyint(2) NOT NULL");}
if(!pdo_fieldexists('hyb_yl_tuike_roul','mode')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_tuike_roul')." ADD   `mode` tinyint(2) NOT NULL");}
if(!pdo_fieldexists('hyb_yl_tuike_roul','ranknum')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_tuike_roul')." ADD   `ranknum` tinyint(2) NOT NULL");}
if(!pdo_fieldexists('hyb_yl_tuike_roul','levelshow')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_tuike_roul')." ADD   `levelshow` tinyint(2) NOT NULL");}
if(!pdo_fieldexists('hyb_yl_tuike_roul','seetstatus')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_tuike_roul')." ADD   `seetstatus` tinyint(2) NOT NULL");}
...
if(!pdo_fieldexists('hyb_yl_tuike_roul','lowestmoney')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_tuike_roul')." ADD   `lowestmoney` float(8,2) NOT NULL");}
...
if(!pdo_fieldexists('hyb_yl_tuike_roul','applymoney')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_tuike_roul')." ADD   `applymoney` float(8,2) NOT NULL");}
if(!pdo_fieldexists('hyb_yl_tuike_roul','modeonemoney')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_tuike_roul')." ADD   `modeonemoney` float(8,2) NOT NULL");}
if(!pdo_fieldexists('hyb_yl_tuike_roul','modetwomoney')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_tuike_roul')." ADD   `modetwomoney` float(8,2) NOT NULL");}
if(!pdo_fieldexists('hyb_yl_tuike_roul','examine')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_tuike_roul')." ADD   `examine` tinyint(2) NOT NULL COMMENT '是否审核'");}
...
if(!pdo_fieldexists('hyb_yl_tuike_roul','twoapplymoney')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_tuike_roul')." ADD   `twoapplymoney` float(8,2) NOT NULL");}
if(!pdo_fieldexists('hyb_yl_tuike_roul','onegetmoney')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_tuike_roul')." ADD   `onegetmoney` float(8,2) NOT NULL");}
if(!pdo_fieldexists('hyb_yl_tuike_roul','twoexamine')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_tuike_roul')." ADD   `twoexamine` tinyint(2) NOT NULL COMMENT '二级是否审核'");}
if(!pdo_fieldexists('hyb_yl_tuike_roul','bindvip')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_tuike_roul')." ADD   `bindvip` tinyint(3) NOT NULL");}
if(!pdo_fieldexists('hyb_yl_tuike_roul','lockstatus')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_tuike_roul')." ADD   `lockstatus` tinyint(2) NOT NULL COMMENT '绑定上下级关系条件'");}
if(!pdo_fieldexists('hyb_yl_tuike_roul','showlock')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_tuike_roul')." ADD   `showlock` tinyint(2) NOT NULL COMMENT '是否显示未锁定下级'");}
...
if(!pdo_fieldexists('hyb_yl_tuike_tixian_log','txprice')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_tuike_tixian_log')." ADD   `txprice` float(10,2) NOT NULL");}
...
if(!pdo_fieldexists('hyb_yl_tuike_tixian_log','tkid')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_tuike_tixian_log')." ADD   `tkid` int(11) NOT NULL");}
if(!pdo_fieldexists('hyb_yl_tuike_tixian_log','addtime')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_tuike_tixian_log')." ADD   `addtime` datetime NOT NULL");}
...
if(!pdo_fieldexists('hyb_yl_tuikeshouyi','money')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_tuikeshouyi')." ADD   `money` float(8,2) NOT NULL");}
if(!pdo_fieldexists('hyb_yl_tuikeshouyi','addtime')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_tuikeshouyi')." ADD   `addtime` datetime NOT NULL");}
...
pdo_query("CREATE TABLE IF NOT EXISTS `ims_hyb_yl_tuikesite` (
  ...
  `erweima` varchar(255) NOT NULL,
  `tkid` int(11) NOT NULL DEFAULT '0',
...
if(!pdo_fieldexists('hyb_yl_tuikesite','username')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_tuikesite')." ADD   `username` varchar(255) NOT NULL");}
if(!pdo_fieldexists('hyb_yl_tuikesite','tel')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_tuikesite')." ADD   `tel` varchar(50) NOT NULL");}
if(!pdo_fieldexists('hyb_yl_tuikesite','address')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_tuikesite')." ADD   `address` text NOT NULL");}
...
if(!pdo_fieldexists('hyb_yl_tuikesite','openid')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_tuikesite')." ADD   `openid` varchar(255) NOT NULL");}
...
if(!pdo_fieldexists('hyb_yl_tuikesite','erweima')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_tuikesite')." ADD   `erweima` varchar(255) NOT NULL");}
if(!pdo_fieldexists('hyb_yl_tuikesite','tkid')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_tuikesite')." ADD   `tkid` int(11) NOT NULL DEFAULT '0'");}
...
if(!pdo_fieldexists('hyb_yl_twenorder','zid')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_twenorder')." ADD   `zid` int(11) NOT NULL");}
if(!pdo_fieldexists('hyb_yl_twenorder','openid')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_twenorder')." ADD   `openid` varchar(255) NOT NULL");}
if(!pdo_fieldexists('hyb_yl_twenorder','orders')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_twenorder')." ADD   `orders` varchar(255) NOT NULL");}
if(!pdo_fieldexists('hyb_yl_twenorder','time')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_twenorder')." ADD   `time` time NOT NULL");}
if(!pdo_fieldexists('hyb_yl_twenorder','content')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_twenorder')." ADD   `content` text CHARACTER SET utf8mb4 NOT NULL");}
...
if(!pdo_fieldexists('hyb_yl_twenorder','money')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_twenorder')." ADD   `money` float(7,2) NOT NULL");}
...
if(!pdo_fieldexists('hyb_yl_twenorder','biaoqian')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_twenorder')." ADD   `biaoqian` varchar(255) NOT NULL");}
...
if(!pdo_fieldexists('hyb_yl_user_address','openid')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_user_address')." ADD   `openid` varchar(255) NOT NULL");}
...
if(!pdo_fieldexists('hyb_yl_user_address','userAddress')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_user_address')." ADD   `userAddress` varchar(255) NOT NULL");}
...
pdo_query("CREATE TABLE IF NOT EXISTS `ims_hyb_yl_user_coupon` (
  ...
  `duihuanma` varchar(255) DEFAULT NULL,
  `deductible_amount` decimal(10,2) NOT NULL DEFAULT '0.00' COMMENT '抵扣金额',
  `applicableservices` varchar(255) DEFAULT NULL COMMENT '适用服务',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='用户优惠券表';
...
if(!pdo_fieldexists('hyb_yl_user_coupon','duihuanma')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_user_coupon')." ADD   `duihuanma` varchar(255) DEFAULT NULL");}
...
pdo_query("CREATE TABLE IF NOT EXISTS `ims_hyb_yl_user_yearcard` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=53 DEFAULT CHARSET=utf8 COMMENT='用户办理年卡记录';
...
if(!pdo_fieldexists('hyb_yl_userbingli','openid')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_userbingli')." ADD   `openid` varchar(255) NOT NULL");}
if(!pdo_fieldexists('hyb_yl_userbingli','userid')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_userbingli')." ADD   `userid` int(11) NOT NULL");}
...
if(!pdo_fieldexists('hyb_yl_userbingli','sicktel')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_userbingli')." ADD   `sicktel` varchar(255) NOT NULL");}
...
if(!pdo_fieldexists('hyb_yl_userchufang','j_id')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_userchufang')." ADD   `j_id` int(11) NOT NULL");}
...
if(!pdo_fieldexists('hyb_yl_userchufang','content')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_userchufang')." ADD   `content` text NOT NULL");}
if(!pdo_fieldexists('hyb_yl_userchufang','timeStar')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_userchufang')." ADD   `timeStar` datetime NOT NULL");}
if(!pdo_fieldexists('hyb_yl_userchufang','openid')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_userchufang')." ADD   `openid` varchar(255) NOT NULL");}
...
if(!pdo_fieldexists('hyb_yl_userdianz','id')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_userdianz')." ADD 
  `id` int(11) NOT NULL AUTO_INCREMENT");}
if(!pdo_fieldexists('hyb_yl_userdianz','openid')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_userdianz')." ADD   `openid` varchar(255) NOT NULL");}
if(!pdo_fieldexists('hyb_yl_userdianz','uniacid')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_userdianz')." ADD   `uniacid` int(11) NOT NULL");}
if(!pdo_fieldexists('hyb_yl_userdianz','p_id')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_userdianz')." ADD   `p_id` int(11) NOT NULL");}
...
if(!pdo_fieldexists('hyb_yl_userdxin','key')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_userdxin')." ADD   `key` varchar(50) NOT NULL");}
if(!pdo_fieldexists('hyb_yl_userdxin','scret')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_userdxin')." ADD   `scret` varchar(50) NOT NULL");}
if(!pdo_fieldexists('hyb_yl_userdxin','qianming')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_userdxin')." ADD   `qianming` varchar(50) NOT NULL");}
if(!pdo_fieldexists('hyb_yl_userdxin','moban_id')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_userdxin')." ADD   `moban_id` varchar(50) NOT NULL");}
...
if(!pdo_fieldexists('hyb_yl_userdxin','stadus')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_userdxin')." ADD   `stadus` int(11) NOT NULL DEFAULT '0'");}
...
if(!pdo_fieldexists('hyb_yl_userinfo','openid')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_userinfo')." ADD   `openid` varchar(255) NOT NULL");}
if(!pdo_fieldexists('hyb_yl_userinfo','u_name')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_userinfo')." ADD   `u_name` varchar(255) NOT NULL");}
if(!pdo_fieldexists('hyb_yl_userinfo','u_thumb')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_userinfo')." ADD   `u_thumb` varchar(255) NOT NULL");}
...
if(!pdo_fieldexists('hyb_yl_userinfo','u_phone')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_userinfo')." ADD   `u_phone` varchar(255) NOT NULL");}
...
if(!pdo_fieldexists('hyb_yl_userinfo','u_label')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_userinfo')." ADD   `u_label` text COMMENT '患者标签'");}
...
pdo_query("CREATE TABLE IF NOT EXISTS `ims_hyb_yl_userjiaren` (
  ...
  `openid` varchar(255) NOT NULL,
  `names` varchar(255) NOT NULL,
  `sex` varchar(11) NOT NULL DEFAULT '男',
  `datetime` varchar(255) NOT NULL COMMENT '出身日期',
  `age` int(11) NOT NULL DEFAULT '0' COMMENT '0',
...
if(!pdo_fieldexists('hyb_yl_userjiaren','openid')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_userjiaren')." ADD   `openid` varchar(255) NOT NULL");}
if(!pdo_fieldexists('hyb_yl_userjiaren','names')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_userjiaren')." ADD   `names` varchar(255) NOT NULL");}
if(!pdo_fieldexists('hyb_yl_userjiaren','sex')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_userjiaren')." ADD   `sex` varchar(11) NOT NULL DEFAULT '男'");}
...
if(!pdo_fieldexists('hyb_yl_userjiaren','age')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_userjiaren')." ADD   `age` int(11) NOT NULL DEFAULT '0' COMMENT '0'");}
...
if(!pdo_fieldexists('hyb_yl_userjiaren','tel')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_userjiaren')." ADD   `tel` varchar(50) NOT NULL");}
...
pdo_query("CREATE TABLE IF NOT EXISTS `ims_hyb_yl_vip_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8 COMMENT='用户会员办理表';
...
pdo_query("CREATE TABLE IF NOT EXISTS `ims_hyb_yl_vip_setting` (
  ...
  `setting_goumai_content` varchar(255) DEFAULT NULL,
  `setting_zengsong_content` varchar(255) DEFAULT NULL,
...
if(!pdo_fieldexists('hyb_yl_vip_setting','setting_goumai_content')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_vip_setting')." ADD   `setting_goumai_content` varchar(255) DEFAULT NULL");}
if(!pdo_fieldexists('hyb_yl_vip_setting','setting_zengsong_content')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_vip_setting')." ADD   `setting_zengsong_content` varchar(255) DEFAULT NULL");}
...
pdo_query("CREATE TABLE IF NOT EXISTS `ims_hyb_yl_visit` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2731 DEFAULT CHARSET=utf8 COMMENT='访问统计表';
...
pdo_query("CREATE TABLE IF NOT EXISTS `ims_hyb_yl_wenzhenrule` (
  ...
  `created` int(11) NOT NULL COMMENT '添加时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='问诊规则设置表';
...
pdo_query("CREATE TABLE IF NOT EXISTS `ims_hyb_yl_wenzorder` (
  ...
  `month_time` varchar(255) NOT NULL,
  `openid` varchar(255) NOT NULL,
  `orders` varchar(255) NOT NULL,
...
if(!pdo_fieldexists('hyb_yl_wenzorder','describe')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_wenzorder')." ADD   `describe` text NOT NULL");}
...
if(!pdo_fieldexists('hyb_yl_wenzorder','keywords')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_wenzorder')." ADD   `keywords` varchar(255) NOT NULL");}
...
if(!pdo_fieldexists('hyb_yl_wenzorder','month_time')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_wenzorder')." ADD   `month_time` varchar(255) NOT NULL");}
if(!pdo_fieldexists('hyb_yl_wenzorder','openid')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_wenzorder')." ADD   `openid` varchar(255) NOT NULL");}
if(!pdo_fieldexists('hyb_yl_wenzorder','orders')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_wenzorder')." ADD   `orders` varchar(255) NOT NULL");}
...
if(!pdo_fieldexists('hyb_yl_wenzorder','zid')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_wenzorder')." ADD   `zid` int(11) NOT NULL");}
...
if(!pdo_fieldexists('hyb_yl_yaoqingdoc','zid')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_yaoqingdoc')." ADD   `zid` int(11) NOT NULL");}
...
pdo_query("CREATE TABLE IF NOT EXISTS `ims_hyb_yl_yaoshi` (
  ...
  `jigou_two` int(11) NOT NULL COMMENT '二级机构id',
  `add_time` int(11) NOT NULL COMMENT '加入时间',
  `status` tinyint(2) NOT NULL COMMENT '状态（0：待审核；1：审核通过；2：审核拒绝；3：暂停中）',
...
if(!pdo_fieldexists('hyb_yl_yaoshi','status')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_yaoshi')." ADD   `status` tinyint(2) NOT NULL COMMENT '状态（0：待审核；1：审核通过；2：审核拒绝；3：暂停中）'");}
...
pdo_query("CREATE TABLE IF NOT EXISTS `ims_hyb_yl_yearcard` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8 COMMENT='年卡列表';
...
if(!pdo_fieldexists('hyb_yl_zhenzhuang','name')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_zhenzhuang')." ADD   `name` varchar(30) NOT NULL");}
...
if(!pdo_fieldexists('hyb_yl_zhenzhuang','icon')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_zhenzhuang')." ADD   `icon` varchar(255) NOT NULL");}
if(!pdo_fieldexists('hyb_yl_zhenzhuang','pid')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_zhenzhuang')." ADD   `pid` int(11) NOT NULL DEFAULT '-1'");}
pdo_query("CREATE TABLE IF NOT EXISTS `ims_hyb_yl_zhuanjia` (
  ...
  `xn_reoly` varchar(50) NOT NULL,
  `xn_cf` varchar(50) NOT NULL,
  `xytime` varchar(50) NOT NULL DEFAULT '分钟',
  `zgzimgurl1back` varchar(255) NOT NULL,
  `z_content` varchar(255) NOT NULL,
...
if(!pdo_fieldexists('hyb_yl_zhuanjia','openid')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_zhuanjia')." ADD   `openid` varchar(255) NOT NULL");}
...
if(!pdo_fieldexists('hyb_yl_zhuanjia','z_sex')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_zhuanjia')." ADD   `z_sex` tinyint(2) NOT NULL");}
if(!pdo_fieldexists('hyb_yl_zhuanjia','sfzbianhao')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_zhuanjia')." ADD   `sfzbianhao` varchar(255) NOT NULL");}
...
if(!pdo_fieldexists('hyb_yl_zhuanjia','z_telephone')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_zhuanjia')." ADD   `z_telephone` varchar(255) NOT NULL");}
...
if(!pdo_fieldexists('hyb_yl_zhuanjia','address')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_zhuanjia')." ADD   `address` varchar(255) NOT NULL");}
...
if(!pdo_fieldexists('hyb_yl_zhuanjia','username')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_zhuanjia')." ADD   `username` varchar(255) NOT NULL");}
if(!pdo_fieldexists('hyb_yl_zhuanjia','password')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_zhuanjia')." ADD   `password` varchar(255) NOT NULL");}
if(!pdo_fieldexists('hyb_yl_zhuanjia','groupid')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_zhuanjia')." ADD   `groupid` varchar(50) NOT NULL");}
...
if(!pdo_fieldexists('hyb_yl_zhuanjia','endtime')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_zhuanjia')." ADD   `endtime` varchar(255) NOT NULL");}
if(!pdo_fieldexists('hyb_yl_zhuanjia','sfzimgurl1back')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_zhuanjia')." ADD   `sfzimgurl1back` varchar(255) NOT NULL");}
if(!pdo_fieldexists('hyb_yl_zhuanjia','sfzimgurl2back')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_zhuanjia')." ADD   `sfzimgurl2back` varchar(255) NOT NULL");}
if(!pdo_fieldexists('hyb_yl_zhuanjia','xn_reoly')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_zhuanjia')." ADD   `xn_reoly` varchar(50) NOT NULL");}
if(!pdo_fieldexists('hyb_yl_zhuanjia','xn_cf')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_zhuanjia')." ADD   `xn_cf` varchar(50) NOT NULL");}
if(!pdo_fieldexists('hyb_yl_zhuanjia','xytime')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_zhuanjia')." ADD   `xytime` varchar(50) NOT NULL DEFAULT '分钟'");}
if(!pdo_fieldexists('hyb_yl_zhuanjia','zgzimgurl1back')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_zhuanjia')." ADD   `zgzimgurl1back` varchar(255) NOT NULL");}
if(!pdo_fieldexists('hyb_yl_zhuanjia','z_content')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_zhuanjia')." ADD   `z_content` varchar(255) NOT NULL");}
if(!pdo_fieldexists('hyb_yl_zhuanjia','plugin')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_zhuanjia')." ADD   `plugin` text NOT NULL");}
if(!pdo_fieldexists('hyb_yl_zhuanjia','opentime')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_zhuanjia')." ADD   `opentime` varchar(50) NOT NULL");}
...
if(!pdo_fieldexists('hyb_yl_zhuanjia_job','job_name')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_zhuanjia_job')." ADD   `job_name` varchar(255) NOT NULL");}
if(!pdo_fieldexists('hyb_yl_zhuanjia_job','job_strot')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_zhuanjia_job')." ADD   `job_strot` int(11) NOT NULL");}
...
pdo_query("CREATE TABLE IF NOT EXISTS `ims_hyb_yl_zhuanjia_rule` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='专家规则设置';
...
if(!pdo_fieldexists('hyb_yl_zhuanjia_select','name')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_zhuanjia_select')." ADD   `name` varchar(50) NOT NULL");}
...
if(!pdo_fieldexists('hyb_yl_zhuanjiafenzu','zid')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_zhuanjiafenzu')." ADD   `zid` int(11) NOT NULL");}
if(!pdo_fieldexists('hyb_yl_zhuanjiafenzu','fenzname')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_zhuanjiafenzu')." ADD   `fenzname` char(50) NOT NULL");}
...
if(!pdo_fieldexists('hyb_yl_zhuanjteam','teamname')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_zhuanjteam')." ADD   `teamname` char(50) NOT NULL");}
if(!pdo_fieldexists('hyb_yl_zhuanjteam','teamaddress')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_zhuanjteam')." ADD   `teamaddress` varchar(255) NOT NULL");}
...
if(!pdo_fieldexists('hyb_yl_zhuanjteam','teamtext')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_zhuanjteam')." ADD   `teamtext` text NOT NULL");}
if(!pdo_fieldexists('hyb_yl_zhuanjteam','teampic')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_zhuanjteam')." ADD   `teampic` varchar(255) NOT NULL");}
if(!pdo_fieldexists('hyb_yl_zhuanjteam','zid')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_zhuanjteam')." ADD   `zid` int(11) NOT NULL");}
...
if(!pdo_fieldexists('hyb_yl_zhuanjteam','tderweima')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_zhuanjteam')." ADD   `tderweima` varchar(255) NOT NULL");}
...
pdo_query("CREATE TABLE IF NOT EXISTS `ims_hyb_yl_zixun` (
  ...
  `time` varchar(255) NOT NULL,
  `sord` int(11) NOT NULL DEFAULT '0',
  `dianj` int(11) unsigned NOT NULL DEFAULT '0',
  ...
  `keshi_one` int(10) NOT NULL DEFAULT '0',
  `keshi_two` int(10) NOT NULL DEFAULT '0',
...
if(!pdo_fieldexists('hyb_yl_zixun','content')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_zixun')." ADD   `content` longtext NOT NULL");}
...
if(!pdo_fieldexists('hyb_yl_zixun','sord')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_zixun')." ADD   `sord` int(11) NOT NULL DEFAULT '0'");}
if(!pdo_fieldexists('hyb_yl_zixun','dianj')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_zixun')." ADD   `dianj` int(11) unsigned NOT NULL DEFAULT '0'");}
...
if(!pdo_fieldexists('hyb_yl_zixun','erweima')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_zixun')." ADD   `erweima` varchar(255) NOT NULL");}
...
if(!pdo_fieldexists('hyb_yl_zixun','keshi_one')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_zixun')." ADD   `keshi_one` int(10) NOT NULL DEFAULT '0'");}
if(!pdo_fieldexists('hyb_yl_zixun','keshi_two')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_zixun')." ADD   `keshi_two` int(10) NOT NULL DEFAULT '0'");}
...
if(!pdo_fieldexists('hyb_yl_zixun_looklog','openid')) {pdo_query("ALTER TABLE ".tablename('hyb_yl_zixun_looklog')." ADD   `openid` varchar(255) DEFAULT NULL");}
