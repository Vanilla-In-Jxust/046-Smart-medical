...
class Menus_sys {
    ...
    public function topmenus() {
        ...
        $appact[] = 'app';
        $url = $_W['siteroot']."app/index.php?i=".$_W['uniacid']."&c=entry&m=hyb_yl&hid=".$_W['hid'];

        $frames['dashboard']['title'] = '<i class="fa fa-desktop"></i>&nbsp;&nbsp; 概况';
        $frames['dashboard']['url'] = $url."&act=index&do=index&op=ispost";
        $frames['dashboard']['active'] = 'index';
        $frames['dashboard']['child'] = $this->getdashboardFrames();

        $frames['zhuanjia']['title'] = '<i class="fa fa-user"></i>&nbsp;&nbsp; 专家';
        $frames['zhuanjia']['url'] = $url."act=zhuanjia&do=zhuanjia&op=index";
        $frames['zhuanjia']['active'] = 'zhuanjia';
        $frames['zhuanjia']['child'] = $this->getZhuanjiaFrames();

        $frames['register']['title'] = '<i class="fa fa-user"></i>&nbsp;&nbsp; 挂号';
        $frames['register']['url'] = $url."act=register&do=register&op=index";
        $frames['register']['active'] = 'register';

        $frames['interrogation']['title'] = '<i class="fa fa-user"></i>&nbsp;&nbsp; 问诊';
        $frames['interrogation']['url'] = $url."act=interrogation&do=interrogation&op=index";
        $frames['interrogation']['active'] = 'interrogation';

        $frames['sign']['title'] = '<i class="fa fa-user"></i>&nbsp;&nbsp; 签约';
        $frames['sign']['url'] = $url."act=sign&do=sign&op=index";
        $frames['sign']['active'] = 'sign';

        $frames['order']['title'] = '<i class="fa fa-user"></i>&nbsp;&nbsp; 订单';
        $frames['order']['url'] = $url."act=order&do=order&op=index";
        $frames['order']['active'] = 'order';

        $frames['finance']['title'] = '<i class="fa fa-user"></i>&nbsp;&nbsp; 财务';
        $frames['finance']['url'] = $url."act=finance&do=finance&op=index";
        $frames['finance']['active'] = 'finance';

		$frames['datas']['title'] = '<i class="fa fa-user"></i>&nbsp;&nbsp; 数据';
        $frames['datas']['url'] = $url."act=datas&do=datas&op=index";
        $frames['datas']['active'] = 'datas';
        return $frames;
    }
    // 概况子菜单
    static function getdashboardFrames() {
        ...
        $frames = array();
        $frames['dashboard']['title'] = '<i class="fa fa-dashboard"></i>&nbsp;&nbsp; 概况';
        $frames['dashboard']['items'] = array();

        $frames['dashboard']['items']['setting']['url'] = $url."&act=index&do=index&op=ispost";
        $frames['dashboard']['items']['setting']['title'] = '运营概况';
        $frames['dashboard']['items']['setting']['active'] = '';

        $frames['dashboard']['items']['order']['url'] = $url."&act=index&do=index&op=order";
        $frames['dashboard']['items']['order']['title'] = '运营概况';
        $frames['dashboard']['items']['order']['active'] = '';

        return $frames;
    }
    // 专家子菜单
    static function getZhuanjiaFrames() {
        global $_W;
        ...
        $frames = array();
        $frames['zhuanjia']['title'] = '<i class="fa fa-dashboard"></i>&nbsp;&nbsp; 专家管理';
        $frames['zhuanjia']['items'] = array();

        $frames['zhuanjia']['items']['index']['url'] = $url."&act=index&do=zhuanjia&op=index";
        $frames['zhuanjia']['items']['index']['title'] = '专家列表';
        $frames['zhuanjia']['items']['index']['active'] = '';

        $frames['zhuanjia']['items']['edit']['url'] = $url."&act=index&do=index&op=edit";
        $frames['zhuanjia']['items']['edit']['title'] = '添加专家';
        $frames['zhuanjia']['items']['edit']['active'] = '';

        $frames['zhuanjia']['items']['scheduling']['url'] = $url."&act=scheduling&do=index&op=scheduling";
        $frames['zhuanjia']['items']['scheduling']['title'] = '排班列表';
        $frames['zhuanjia']['items']['scheduling']['active'] = '';

        $frames['zhuanjia']['items']['jxbiaoqian']['url'] = $url."&act=jxbiaoqian&do=index&op=jxbiaoqian";
        $frames['zhuanjia']['items']['jxbiaoqian']['title'] = '精选标签';
        $frames['zhuanjia']['items']['jxbiaoqian']['active'] = '';


        $frames['service']['title'] = '<i class="fa fa-dashboard"></i>&nbsp;&nbsp; 服务包管理';
        $frames['service']['items'] = array();

        $frames['service']['items']['service']['url'] = $url."&act=service&do=zhuanjia&op=service";
        $frames['service']['items']['service']['title'] = '开通记录';
        $frames['service']['items']['service']['active'] = '';

        $frames['card']['title'] = '<i class="fa fa-dashboard"></i>&nbsp;&nbsp; 专家年卡';
        $frames['card']['items'] = array();

        $frames['card']['items']['card']['url'] = $url."&act=service&do=zhuanjia&op=card";
        $frames['card']['items']['card']['title'] = '年卡列表';
        $frames['card']['items']['card']['active'] = '';

        $frames['card']['items']['cardlist']['url'] = $url."&act=index&do=index&op=cardlist";
        $frames['card']['items']['cardlist']['title'] = '办卡记录';
        $frames['card']['items']['cardlist']['active'] = '';

        $frames['card']['title'] = '<i class="fa fa-dashboard"></i>&nbsp;&nbsp; 评价与动态';
        $frames['card']['items'] = array();
