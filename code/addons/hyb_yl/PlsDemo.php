...
class PlsDemo
{
    ...
    function __construct($app_key,$app_secrt,$areaCode) {
        $this->app_key = $app_key;
        $this->app_secrt = $app_secrt;
        $this->areaCode = $areaCode;
    }
  //绑定
public function getBangdin($doc_ph,$app_key,$app_secrt,$areaCode){
...
public function getAcsClient($user_phone, $doc_phone,$privateNum) {
    // 必填,请参考"开发准备"获取如下数据,替换为实际值
    $realUrl = 'https://rtcapi.cn-north-1.myhuaweicloud.com:12543/rest/caas/privatenumber/calleenumber/v1.0'; // APP接入地址+接口访问URI
    $APP_KEY = $this->app_key; // APP_Key
    $APP_SECRET = $this->app_secrt; // APP_Secret
