...
class WeixinTx {
    ...
    private function xmltoarray($xml) {
      ...
      curl_setopt($ch, CURLOPT_SSLCERT,getcwd().'/cert/hyb_yl/apiclient_cert.pem'); //这个是证书的位置
      curl_setopt($ch, CURLOPT_SSLKEY,getcwd().'/cert/hyb_yl/apiclient_key.pem'); //这个也是证书的位置
