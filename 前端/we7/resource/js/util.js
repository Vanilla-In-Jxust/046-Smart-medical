var _interopRequireDefault = require("../../../@babel/runtime/helpers/interopRequireDefault"), _defineProperty2 = _interopRequireDefault(require("../../../@babel/runtime/helpers/defineProperty")), _typeof2 = _interopRequireDefault(require("../../../@babel/runtime/helpers/typeof")), util = {};
...
function getSign(e, t, a) {
    var n = require("underscore.js"), r = require("md5.js"), i = "", s = getUrlParam(e, "sign");
...
util.url = function(e, t) {
    var a = getApp(), n = a.siteInfo.siteroot + "?i=" + a.siteInfo.uniacid + "&t=" + a.siteInfo.multiid + "&v=" + a.siteInfo.version + "&from=wxapp&c=entry&a=wxapp&do=copysite&m=hyb_yl";
    if (e && (e = e.split("/"))[0] && (n += "&act=" + e[2]), t && "object" === (0, _typeof2.default)(t)) for (var r in t) r && t.hasOwnProperty(params) && t[r] && (n += r + "=" + t[r] + "&");
    return n;
    ...
    }, (0, _defineProperty2.default)(t, "header", {
        "content-type": "application/x-www-form-urlencoded"
    }), (0, _defineProperty2.default)(t, "success", function(t) {
        if (wx.hideNavigationBarLoading(), t.data.errno) {
    ...
    }), (0, _defineProperty2.default)(t, "fail", function(t) {
    ...
    }), (0, _defineProperty2.default)(t, "complete", function(t) {
        ...
        wx.login({
            success: function(a) {
                console.log(a), util.request({
                    ...
                    cachetime: 0,
                    success: function(a) {
                        console.log(a), a.data.errno || (t.sessionid = a.data.data.sessionid, wx.setStorageSync("userInfo", t), 
                        wx.getUserInfo({
                            success: function(a) {
