...
require("../../../@babel/runtime/helpers/Arrayincludes"), function() {
    ...
    function j(n) {
        return function(r, t, e, u) {
            t = v(t, u, 4);
            var i = !b(r) && h.keys(r), o = (i || r).length, a = n > 0 ? 0 : o - 1;
    ...
    n.default)(Int8Array)) && (h.isFunction = function(n) {
    ...
    h.escape = I(S), h.unescape = I(E), h.result = function(n, r, t) {
    ...
    h.mixin = function(n) {
        h.each(h.functions(n), function(r) {
            ...
            h.prototype[r] = function() {
                var n = [ this._wrapped ];
                return u.apply(n, arguments), T(this, t.apply(h, n));
            };
        });
        ...
        var t = r[n];
        h.prototype[n] = function() {
            return T(this, t.apply(this._wrapped, arguments));
        };
