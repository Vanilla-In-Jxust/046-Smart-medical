...
Page({
    ...
    onLoad: function(a) {
        var e = this, i = t.siteInfo.uniacid, n = a.zid;
        if (a.arr) {
            var o = a.arr, s = o.split(",");
            e.setData({
                count: s.length,
                uid_arr: s,
                uid: o
    ...
    publishBtn: function() {
        var a = this;
        if (a.data.uid_arr.length <= 0) wx.showToast({
            title: "请先选择患者",
            icon: "none",
            duration: 2e3
        }); else {
            var e = a.data.ystext, i = a.data.uid;
            if (1 == a.data.ystype) {
                console.log("123");
                var n = a.data.hjlistinfo.h_id;
            } else {
                n = 0;
                console.log("qwe");
            }
            ...
            wx.showToast({
                ...
                console.log(o), t.util.request({
                    url: "entry/wxapp/yishuo.saveyishuo",
                    data: {
                        zid: a.data.zid,
                        hid: n,
                        yspic: o,
