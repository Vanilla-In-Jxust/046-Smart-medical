...
Page({
    ...
    onclick: function(t) {
        ...
        var e = this;
        wx.request({
            url: a.globalData.dic + "doctor/education/doctorEducation/0/" + e.data.prenumber + "/" + e.data.token,
            data: {
                title: e.data.input
            },
            success: function(a) {
    ...
    lower: function() {
        if (!this.data.noFlag && !this.data.closureFlag) {
            ...
            var t, e = this, o = this.data.page, n = e.data.arr;
            wx.request({
                url: a.globalData.dic + "doctor/education/doctorEducation/" + o + "/" + e.data.prenumber + "/" + e.data.token,
                data: {
                    title: e.data.input
                },
                success: function(a) {
                    if (console.log(a), 200 == a.data.code) {
                        ...
                        var i = a.data.data;
                        if (t = n.concat(i), a.data.data.length == []) return e.setData({
                            noFlag: !0,
                            closureFlag: !1
                        }), !1;
                        wx.showLoading({
