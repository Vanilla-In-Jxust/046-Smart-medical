Page({
    data: {
        wenda: [ {
            id: 0,
            img: "/hyb_yl/images/header_01.png",
            niming: "匿名用户",
            state: 0,
            con: "返几块大水井坊莱克斯顿解放路卡发链接为发胜利大街发狂了三解放路开始就流口水的解放路看电视",
            states: 1,
            imgArr: [ "/hyb_yl/images/background.png", "/hyb_yl/images/background.png", "/hyb_yl/images/background.png", "/hyb_yl/images/background.png", "/hyb_yl/images/background.png", "/hyb_yl/images/background.png", "/hyb_yl/images/background.png", "/hyb_yl/images/background.png" ]
        } ],
        doctor: [ {
            id: 1,
            image: "/hyb_yl/images/header_02.png",
            zhuan: "小猪佩奇",
            zhi: "主治医师",
    ...
    docAnswerClick: function() {
        wx.navigateTo({
            url: "/hyb_yl/userLife/pages/doc_answer/doc_answer"
        });
    },
    payClick: function(a) {
