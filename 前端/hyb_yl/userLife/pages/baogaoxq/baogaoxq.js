...
Page({
    ...
    sendBtn: function(t) {
        ...
        n.util.request({
            url: "entry/wxapp/share.baogaopinglunadd",
            data: {
    ...
    toLike: function(t) {
        ...
        console.log(e), 0 == e ? n.util.request({
            url: "entry/wxapp/share.baogaouserdianz",
            data: {
                op: "dianzan",
                parentid: i,
        ...
        wx.showModal({
            ...
            success: function(t) {
                t.confirm && n.util.request({
                    url: "entry/wxapp/share.deletecontentbaogao",
                    data: {
                        a_id: a
                    },
                    success: function(t) {
    ...
    onLoad: function(t) {
        var a = this, e = t.a_id, o = i.formatTime(new Date()), r = wx.getStorageSync("color"), s = wx.getStorageSync("userInfo"), l = wx.getStorageSync("openid"), d = t.names;
        if (s.u_thumb) var c = s.u_thumb, u = s.u_name; else c = s.avatarUrl, u = s.nickName;
        console.log(s), wx.setNavigationBarColor({
            ...
            url: "entry/wxapp/share.baogaodatainfo",
            data: {
                a_id: e,
                openid: wx.getStorageSync("openid")
            },
    ...
    removepl: function(t) {
        ...
        wx.showModal({
            ...
            success: function(t) {
                t.confirm && n.util.request({
                    url: "entry/wxapp/share.deleteplbaogao",
                    data: {
                        pl_id: e
                    },
                    success: function(t) {
    ...
    getAllpinglun: function() {
        ...
        n.util.request({
            url: "entry/wxapp/share.baogaoallpinglunlist",
            data: {
                a_id: a
            },
            success: function(a) {
