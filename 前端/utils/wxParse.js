...
function i(e) {
    ...
    void 0 !== t && t.length > 0 && r(e, a, this, t);
}
...
function n(e, t, a, i) {
    ...
    return e > (r = s - 2 * l) ? (d = (n = r) * t / e, o.imageWidth = n, o.imageheight = d) : (o.imageWidth = e, 
    o.imageheight = t), o;
}

var d = e(require("./showdown.js")), o = e(require("./html2json.js")), s = 0;

wx.getSystemInfo({
    success: function(e) {
        s = e.windowWidth, e.windowHeight;
    }
}), module.exports = {
    wxParse: function() {
        ...
        if ("html" == t) g = o.default.html2json(r, e); else if ("md" == t || "markdown" == t) {
            ...
            g = o.default.html2json(h, e), console.log(JSON.stringify(g, " ", " "));
        }
